...
wire   [31:0] empty_63_fu_582_p2;
reg   [31:0] empty_63_reg_1241;
...
wire   [3:0] i_32_fu_649_p2;
reg   [3:0] i_32_reg_1283;
...
reg   [28:0] tmp_280_reg_1326;
wire   [32:0] zext_ln401_2_fu_769_p1;
reg   [32:0] zext_ln401_2_reg_1331;
wire   [28:0] i_33_fu_781_p2;
reg   [28:0] i_33_reg_1339;
...
reg   [4:0] tmp_282_reg_1378;
wire   [4:0] i_34_fu_900_p2;
reg   [4:0] i_34_reg_1387;
...
wire   [31:0] i_36_fu_1083_p2;
reg   [31:0] i_36_reg_1477;
wire   [0:0] icmp_ln425_fu_1078_p2;
wire   [3:0] i_37_fu_1115_p2;
reg   [3:0] i_37_reg_1490;
...
wire   [28:0] tmp_279_fu_745_p4;
wire   [31:0] shl_ln17_fu_787_p3;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln389_fu_527_p2 == 1'd0) & (icmp_ln387_fu_514_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        empty_63_reg_1241 <= empty_63_fu_582_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln399_1_fu_739_p2 == 1'd0) & (icmp_ln399_fu_723_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state7))) begin
        tmp_280_reg_1326 <= {{sub_ln399_fu_729_p2[31:3]}};
...
always @ (posedge ap_clk) begin
    if (((icmp_ln408_fu_860_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state11))) begin
        tmp_282_reg_1378 <= {{indvars_iv_reg_373[7:3]}};
...
assign add_ln390_fu_660_p2 = (zext_ln389_reg_1225 + empty_63_reg_1241);
...
assign add_ln394_fu_599_p2 = (empty_63_fu_582_p2 + pos_cast1_reg_1211);
...
assign and_ln_fu_1000_p3 = {{tmp_282_reg_1378}, {3'd0}};
...
assign empty_61_fu_548_p1 = sub_ln391_fu_542_p2;

assign empty_62_fu_558_p2 = ((xor_ln391_fu_533_p2 > xor_ln391_1_fu_552_p2) ? 1'b1 : 1'b0);

assign empty_63_fu_582_p2 = (trunc_ln391_fu_572_p1 ^ 32'd4294967295);

assign empty_64_fu_607_p1 = p_05_rec_reg_242[13:0];
...
assign i_32_fu_649_p2 = (i_0_i_reg_263 + 4'd1);

assign i_33_fu_781_p2 = (i_1_reg_319 + 29'd1);

assign i_34_fu_900_p2 = (i_2_reg_396 + 5'd1);

assign i_35_fu_1047_p2 = (i_4_reg_418 + 4'd1);

assign i_36_fu_1083_p2 = (32'd1 + i_5_reg_429);

assign i_37_fu_1115_p2 = (i_0_i1_reg_440 + 4'd1);
...
assign icmp_ln400_fu_776_p2 = ((i_1_reg_319 == tmp_280_reg_1326) ? 1'b1 : 1'b0);

assign icmp_ln408_fu_860_p2 = ((indvars_iv_reg_373 < 64'd136) ? 1'b1 : 1'b0);

assign icmp_ln409_fu_894_p2 = ((i_2_reg_396 == 5'd17) ? 1'b1 : 1'b0);

assign icmp_ln416_fu_951_p2 = ((i_3_reg_407 == tmp_282_reg_1378) ? 1'b1 : 1'b0);
...
assign shl_ln17_fu_787_p3 = {{i_1_reg_319}, {3'd0}};

assign shl_ln18_fu_966_p3 = {{trunc_ln417_fu_962_p1}, {3'd0}};

assign shl_ln19_fu_906_p3 = {{i_2_reg_396}, {3'd0}};
...
assign sum1_fu_611_p2 = (m_offset_cast17_reg_1257 + empty_64_fu_607_p1);

assign tmp_279_fu_745_p4 = {{ap_phi_mux_p_12_phi_fu_302_p4[31:3]}};

assign tmp_281_fu_870_p4 = {{p_23_reg_344[31:3]}};
...
assign umax_fu_564_p3 = ((empty_62_fu_558_p2[0:0] === 1'b1) ? xor_ln391_fu_533_p2 : xor_ln391_1_fu_552_p2);

assign xor_ln391_1_fu_552_p2 = (empty_61_fu_548_p1 ^ 64'd18446744073709551615);
...
assign zext_ln400_1_fu_755_p1 = tmp_279_fu_745_p4;
