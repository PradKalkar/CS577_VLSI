...
wire    grp_unpack_sk_fu_1358_ap_ready;
wire    grp_unpack_sk_fu_1358_ap_done;
...
wire   [5:0] shl_ln22_fu_1659_p3;
reg   [5:0] shl_ln22_reg_3384;
...
wire   [63:0] tmp_284_fu_2321_p3;
reg   [63:0] tmp_284_reg_3583;
...
wire   [63:0] tmp_285_fu_2347_p3;
reg   [63:0] tmp_285_reg_3602;
...
wire   [63:0] tmp_286_fu_2373_p3;
reg   [63:0] tmp_286_reg_3621;
...
wire    grp_pack_sig_fu_1350_ap_start;
wire    grp_pack_sig_fu_1350_ap_done;
wire    grp_pack_sig_fu_1350_ap_idle;
wire    grp_pack_sig_fu_1350_ap_ready;
wire   [12:0] grp_pack_sig_fu_1350_sig_address0;
wire    grp_pack_sig_fu_1350_sig_ce0;
wire    grp_pack_sig_fu_1350_sig_we0;
wire   [7:0] grp_pack_sig_fu_1350_sig_d0;
wire   [12:0] grp_pack_sig_fu_1350_sig_address1;
wire    grp_pack_sig_fu_1350_sig_ce1;
wire    grp_pack_sig_fu_1350_sig_we1;
wire   [7:0] grp_pack_sig_fu_1350_sig_d1;
wire   [9:0] grp_pack_sig_fu_1350_z_vec_coeffs_address0;
wire    grp_pack_sig_fu_1350_z_vec_coeffs_ce0;
wire   [9:0] grp_pack_sig_fu_1350_h_vec_coeffs_address0;
wire    grp_pack_sig_fu_1350_h_vec_coeffs_ce0;
wire    grp_unpack_sk_fu_1358_ap_start;
wire    grp_unpack_sk_fu_1358_ap_idle;
wire   [7:0] grp_unpack_sk_fu_1358_rho_address0;
wire    grp_unpack_sk_fu_1358_rho_ce0;
wire    grp_unpack_sk_fu_1358_rho_we0;
wire   [7:0] grp_unpack_sk_fu_1358_rho_d0;
wire   [9:0] grp_unpack_sk_fu_1358_t0_vec_coeffs_address0;
wire    grp_unpack_sk_fu_1358_t0_vec_coeffs_ce0;
wire    grp_unpack_sk_fu_1358_t0_vec_coeffs_we0;
wire   [31:0] grp_unpack_sk_fu_1358_t0_vec_coeffs_d0;
wire   [9:0] grp_unpack_sk_fu_1358_t0_vec_coeffs_address1;
wire    grp_unpack_sk_fu_1358_t0_vec_coeffs_ce1;
wire    grp_unpack_sk_fu_1358_t0_vec_coeffs_we1;
wire   [31:0] grp_unpack_sk_fu_1358_t0_vec_coeffs_d1;
wire   [9:0] grp_unpack_sk_fu_1358_s1_vec_coeffs_address0;
wire    grp_unpack_sk_fu_1358_s1_vec_coeffs_ce0;
wire    grp_unpack_sk_fu_1358_s1_vec_coeffs_we0;
wire   [31:0] grp_unpack_sk_fu_1358_s1_vec_coeffs_d0;
wire   [9:0] grp_unpack_sk_fu_1358_s1_vec_coeffs_address1;
wire    grp_unpack_sk_fu_1358_s1_vec_coeffs_ce1;
wire    grp_unpack_sk_fu_1358_s1_vec_coeffs_we1;
wire   [31:0] grp_unpack_sk_fu_1358_s1_vec_coeffs_d1;
wire   [9:0] grp_unpack_sk_fu_1358_s2_vec_coeffs_address0;
wire    grp_unpack_sk_fu_1358_s2_vec_coeffs_ce0;
wire    grp_unpack_sk_fu_1358_s2_vec_coeffs_we0;
wire   [31:0] grp_unpack_sk_fu_1358_s2_vec_coeffs_d0;
wire   [9:0] grp_unpack_sk_fu_1358_s2_vec_coeffs_address1;
wire    grp_unpack_sk_fu_1358_s2_vec_coeffs_ce1;
wire    grp_unpack_sk_fu_1358_s2_vec_coeffs_we1;
wire   [31:0] grp_unpack_sk_fu_1358_s2_vec_coeffs_d1;
wire   [11:0] grp_unpack_sk_fu_1358_sk_address0;
wire    grp_unpack_sk_fu_1358_sk_ce0;
wire   [11:0] grp_unpack_sk_fu_1358_sk_address1;
wire    grp_unpack_sk_fu_1358_sk_ce1;
...
reg    grp_pack_sig_fu_1350_ap_start_reg;
wire    ap_CS_fsm_state118;
reg    grp_unpack_sk_fu_1358_ap_start_reg;
...
#0 grp_pack_sig_fu_1350_ap_start_reg = 1'b0;
#0 grp_unpack_sk_fu_1358_ap_start_reg = 1'b0;
...
s1_vec_coeffs_U(
    ...
    .d1(grp_unpack_sk_fu_1358_s1_vec_coeffs_d1),
    .q1(s1_vec_coeffs_q1)
);
...
t0_vec_coeffs_U(
    ...
    .d1(grp_unpack_sk_fu_1358_t0_vec_coeffs_d1),
    .q1(t0_vec_coeffs_q1)
);
...
s2_vec_coeffs_U(
    ...
    .d1(grp_unpack_sk_fu_1358_s2_vec_coeffs_d1),
    .q1(s2_vec_coeffs_q1)
);
...
pack_sig grp_pack_sig_fu_1350(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_pack_sig_fu_1350_ap_start),
    .ap_done(grp_pack_sig_fu_1350_ap_done),
    .ap_idle(grp_pack_sig_fu_1350_ap_idle),
    .ap_ready(grp_pack_sig_fu_1350_ap_ready),
    .sig_address0(grp_pack_sig_fu_1350_sig_address0),
    .sig_ce0(grp_pack_sig_fu_1350_sig_ce0),
    .sig_we0(grp_pack_sig_fu_1350_sig_we0),
    .sig_d0(grp_pack_sig_fu_1350_sig_d0),
    .sig_address1(grp_pack_sig_fu_1350_sig_address1),
    .sig_ce1(grp_pack_sig_fu_1350_sig_ce1),
    .sig_we1(grp_pack_sig_fu_1350_sig_we1),
    .sig_d1(grp_pack_sig_fu_1350_sig_d1),
    .z_vec_coeffs_address0(grp_pack_sig_fu_1350_z_vec_coeffs_address0),
    .z_vec_coeffs_ce0(grp_pack_sig_fu_1350_z_vec_coeffs_ce0),
    .z_vec_coeffs_q0(z_vec_coeffs_q0),
    .h_vec_coeffs_address0(grp_pack_sig_fu_1350_h_vec_coeffs_address0),
    .h_vec_coeffs_ce0(grp_pack_sig_fu_1350_h_vec_coeffs_ce0),
    .h_vec_coeffs_q0(h_vec_coeffs_q0)
);

unpack_sk grp_unpack_sk_fu_1358(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_unpack_sk_fu_1358_ap_start),
    .ap_done(grp_unpack_sk_fu_1358_ap_done),
    .ap_idle(grp_unpack_sk_fu_1358_ap_idle),
    .ap_ready(grp_unpack_sk_fu_1358_ap_ready),
    .rho_address0(grp_unpack_sk_fu_1358_rho_address0),
    .rho_ce0(grp_unpack_sk_fu_1358_rho_ce0),
    .rho_we0(grp_unpack_sk_fu_1358_rho_we0),
    .rho_d0(grp_unpack_sk_fu_1358_rho_d0),
    .t0_vec_coeffs_address0(grp_unpack_sk_fu_1358_t0_vec_coeffs_address0),
    .t0_vec_coeffs_ce0(grp_unpack_sk_fu_1358_t0_vec_coeffs_ce0),
    .t0_vec_coeffs_we0(grp_unpack_sk_fu_1358_t0_vec_coeffs_we0),
    .t0_vec_coeffs_d0(grp_unpack_sk_fu_1358_t0_vec_coeffs_d0),
    .t0_vec_coeffs_address1(grp_unpack_sk_fu_1358_t0_vec_coeffs_address1),
    .t0_vec_coeffs_ce1(grp_unpack_sk_fu_1358_t0_vec_coeffs_ce1),
    .t0_vec_coeffs_we1(grp_unpack_sk_fu_1358_t0_vec_coeffs_we1),
    .t0_vec_coeffs_d1(grp_unpack_sk_fu_1358_t0_vec_coeffs_d1),
    .s1_vec_coeffs_address0(grp_unpack_sk_fu_1358_s1_vec_coeffs_address0),
    .s1_vec_coeffs_ce0(grp_unpack_sk_fu_1358_s1_vec_coeffs_ce0),
    .s1_vec_coeffs_we0(grp_unpack_sk_fu_1358_s1_vec_coeffs_we0),
    .s1_vec_coeffs_d0(grp_unpack_sk_fu_1358_s1_vec_coeffs_d0),
    .s1_vec_coeffs_address1(grp_unpack_sk_fu_1358_s1_vec_coeffs_address1),
    .s1_vec_coeffs_ce1(grp_unpack_sk_fu_1358_s1_vec_coeffs_ce1),
    .s1_vec_coeffs_we1(grp_unpack_sk_fu_1358_s1_vec_coeffs_we1),
    .s1_vec_coeffs_d1(grp_unpack_sk_fu_1358_s1_vec_coeffs_d1),
    .s2_vec_coeffs_address0(grp_unpack_sk_fu_1358_s2_vec_coeffs_address0),
    .s2_vec_coeffs_ce0(grp_unpack_sk_fu_1358_s2_vec_coeffs_ce0),
    .s2_vec_coeffs_we0(grp_unpack_sk_fu_1358_s2_vec_coeffs_we0),
    .s2_vec_coeffs_d0(grp_unpack_sk_fu_1358_s2_vec_coeffs_d0),
    .s2_vec_coeffs_address1(grp_unpack_sk_fu_1358_s2_vec_coeffs_address1),
    .s2_vec_coeffs_ce1(grp_unpack_sk_fu_1358_s2_vec_coeffs_ce1),
    .s2_vec_coeffs_we1(grp_unpack_sk_fu_1358_s2_vec_coeffs_we1),
    .s2_vec_coeffs_d1(grp_unpack_sk_fu_1358_s2_vec_coeffs_d1),
    .sk_address0(grp_unpack_sk_fu_1358_sk_address0),
    .sk_ce0(grp_unpack_sk_fu_1358_sk_ce0),
    .sk_q0(sk_q0),
    .sk_address1(grp_unpack_sk_fu_1358_sk_address1),
    .sk_ce1(grp_unpack_sk_fu_1358_sk_ce1),
    .sk_q1(sk_q1)
);
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_pack_sig_fu_1350_ap_start_reg <= 1'b0;
    end else begin
        if (((icmp_ln392_fu_3190_p2 == 1'd1) & (icmp_ln158_reg_3824 == 1'd1) & (tmp_5_reg_3889 == 1'd0) & (tmp_s_reg_3885 == 1'd0) & (icmp_ln172_fu_3214_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state115))) begin
            grp_pack_sig_fu_1350_ap_start_reg <= 1'b1;
        end else if ((grp_pack_sig_fu_1350_ap_ready == 1'b1)) begin
            grp_pack_sig_fu_1350_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_unpack_sk_fu_1358_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
            grp_unpack_sk_fu_1358_ap_start_reg <= 1'b1;
        end else if ((grp_unpack_sk_fu_1358_ap_ready == 1'b1)) begin
            grp_unpack_sk_fu_1358_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((grp_unpack_sk_fu_1358_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state44)) begin
        ...
        tmp_284_reg_3583[7 : 0] <= tmp_284_fu_2321_p3[7 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state46)) begin
        ...
        tmp_285_reg_3602[7 : 0] <= tmp_285_fu_2347_p3[7 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state48)) begin
        ...
        tmp_286_reg_3621[7 : 0] <= tmp_286_fu_2373_p3[7 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state14)) begin
        shl_ln22_reg_3384[5 : 3] <= shl_ln22_fu_1659_p3[5 : 3];
    end
end
...
always @ (*) begin
    if ((((grp_pack_sig_fu_1350_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state118)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((grp_pack_sig_fu_1350_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state118))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state30)) begin
        ...
        seedbuf_address0 = grp_unpack_sk_fu_1358_rho_address0;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state27) | (1'b1 == ap_CS_fsm_state20) | (1'b1 == ap_CS_fsm_state29) | (1'b1 == ap_CS_fsm_state28) | (1'b1 == ap_CS_fsm_state16) | (1'b1 == ap_CS_fsm_state15) | (1'b1 == ap_CS_fsm_state14) | (1'b1 == ap_CS_fsm_state30) | (1'b1 == ap_CS_fsm_state17))) begin
        ...
        seedbuf_ce0 = grp_unpack_sk_fu_1358_rho_ce0;
    end else if ((1'b1 == ap_CS_fsm_state41)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state30)) begin
        ...
        seedbuf_d0 = grp_unpack_sk_fu_1358_rho_d0;
    end else begin
        seedbuf_d0 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state27) | (1'b1 == ap_CS_fsm_state29) | (1'b1 == ap_CS_fsm_state28) | (1'b1 == ap_CS_fsm_state16) | (1'b1 == ap_CS_fsm_state15) | (1'b1 == ap_CS_fsm_state14) | (1'b1 == ap_CS_fsm_state30) | (1'b1 == ap_CS_fsm_state17))) begin
        ...
        seedbuf_we0 = grp_unpack_sk_fu_1358_rho_we0;
    end else begin
        seedbuf_we0 = 1'b0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state87)) begin
        ...
        y_vec_coeffs_address0 = tmp_286_fu_2373_p3;
    end else if ((1'b1 == ap_CS_fsm_state46)) begin
        y_vec_coeffs_address0 = tmp_285_fu_2347_p3;
    end else if ((1'b1 == ap_CS_fsm_state44)) begin
        y_vec_coeffs_address0 = tmp_284_fu_2321_p3;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state93)) begin
        ...
        z_vec_coeffs_address0 = tmp_286_reg_3621;
    end else if ((1'b1 == ap_CS_fsm_state47)) begin
        z_vec_coeffs_address0 = tmp_285_reg_3602;
    end else if ((1'b1 == ap_CS_fsm_state45)) begin
        z_vec_coeffs_address0 = tmp_284_reg_3583;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((grp_unpack_sk_fu_1358_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign grp_pack_sig_fu_1350_ap_start = grp_pack_sig_fu_1350_ap_start_reg;
...
assign grp_unpack_sk_fu_1358_ap_start = grp_unpack_sk_fu_1358_ap_start_reg;
...
assign shl_ln22_fu_1659_p3 = {{i_3_i_reg_844}, {3'd0}};

assign shl_ln23_fu_1856_p3 = {{i_3_i1_reg_867}, {3'd0}};

assign shl_ln24_fu_1910_p3 = {{trunc_ln31_fu_1906_p1}, {3'd0}};
...
assign sk_address0 = grp_unpack_sk_fu_1358_sk_address0;

assign sk_address1 = grp_unpack_sk_fu_1358_sk_address1;

assign sk_ce0 = grp_unpack_sk_fu_1358_sk_ce0;

assign sk_ce1 = grp_unpack_sk_fu_1358_sk_ce1;
...
assign tmp_284_fu_2321_p3 = {{56'd1}, {phi_ln124_1_reg_997}};

assign tmp_285_fu_2347_p3 = {{56'd2}, {phi_ln124_2_reg_1008}};

assign tmp_286_fu_2373_p3 = {{56'd3}, {phi_ln124_3_reg_1019}};

assign tmp_287_fu_2429_p3 = {{i_0_i19_reg_1054}, {8'd0}};

assign tmp_288_fu_2742_p3 = {{i_0_i43_reg_1098}, {8'd0}};

assign tmp_289_fu_2864_p3 = {{i_0_i51_reg_1132}, {8'd0}};

assign tmp_290_fu_2926_p3 = {{i_0_i59_reg_1154}, {8'd0}};

assign tmp_291_fu_2996_p3 = {{i_0_i85_reg_1176}, {8'd0}};

assign tmp_292_fu_3086_p3 = {{i_0_i66_reg_1198}, {8'd0}};

assign tmp_293_fu_3144_p3 = {{i_0_i74_reg_1220}, {8'd0}};

assign tmp_294_fu_3202_p3 = {{i_0_i87_reg_1242}, {8'd0}};
...
assign zext_ln104_fu_3094_p1 = tmp_292_fu_3086_p3;
...
assign zext_ln176_fu_2750_p1 = tmp_288_fu_2742_p3;
...
assign zext_ln26_fu_1864_p1 = shl_ln23_fu_1856_p3;

assign zext_ln287_fu_3004_p1 = tmp_291_fu_2996_p3;

assign zext_ln28_fu_2934_p1 = tmp_290_fu_2926_p3;
...
assign zext_ln31_20_fu_1918_p1 = shl_ln24_fu_1910_p3;
...
assign zext_ln541_fu_1667_p1 = shl_ln22_fu_1659_p3;
...
assign zext_ln83_1_fu_3152_p1 = tmp_293_fu_3144_p3;

assign zext_ln83_fu_2872_p1 = tmp_289_fu_2864_p3;
...
always @ (posedge ap_clk) begin
    ...
    tmp_284_reg_3583[63:8] <= 56'b00000000000000000000000000000000000000000000000000000001;
    tmp_285_reg_3602[63:8] <= 56'b00000000000000000000000000000000000000000000000000000010;
    tmp_286_reg_3621[63:8] <= 56'b00000000000000000000000000000000000000000000000000000011;
