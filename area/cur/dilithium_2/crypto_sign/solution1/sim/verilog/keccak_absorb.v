...
always @ (posedge ap_clk) begin
    if (((icmp_ln408_fu_763_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state9))) begin
        tmp_283_reg_1266 <= {{indvars_iv_reg_333[7:3]}};
...
assign and_ln_fu_891_p3 = {{tmp_283_reg_1266}, {3'd0}};
...
assign icmp_ln416_fu_846_p2 = ((i_3_reg_366 == tmp_283_reg_1266) ? 1'b1 : 1'b0);
...
assign shl_ln20_fu_857_p3 = {{i_3_reg_366}, {3'd0}};

assign shl_ln21_fu_803_p3 = {{i_2_reg_355}, {3'd0}};
...
assign zext_ln410_fu_811_p1 = shl_ln21_fu_803_p3;
...
assign zext_ln417_fu_865_p1 = shl_ln20_fu_857_p3;
