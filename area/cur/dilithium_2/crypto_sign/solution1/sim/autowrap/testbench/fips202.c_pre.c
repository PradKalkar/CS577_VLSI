# 1 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
# 1 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c" 2
...
typedef int wchar_t;
# 9 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c" 2
...
# 10 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c" 2
...
# 11 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c" 2
# 26 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
...
# 44 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
...
# 86 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
...
# 359 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
...
# 380 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
...
# 445 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
...
# 468 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
...
# 499 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
                                   ...
                                   unsigned int pos)
{
  ...
  for(i=0;i<outlen/8;i++) {
     ...
     out[8*i+4] = (s[pos/8+i] >> 32)%256;
     out[8*i+5] = (s[pos/8+i] >> 40)%256;
     out[8*i+6] = (s[pos/8+i] >> 48)%256;
     out[8*i+7] = (s[pos/8+i] >> 56)%256;
  }
...
# 572 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void shake128_init(keccak_state *state)
{
  keccak_init(state);
}
# 587 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void shake128_absorb(keccak_state *state, const uint8_t *in, size_t inlen)
{
  state->pos = keccak_absorb(state->s, 168, state->pos, in, inlen);
}
# 599 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void shake128_finalize(keccak_state *state)
{
  keccak_finalize(state->s, 168, state->pos, 0x1F);
  state->pos = 0;
}
# 618 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void shake128_squeezeblocks(uint8_t *out, size_t nblocks, keccak_state *state)
{
  keccak_squeezeblocks(out, nblocks, state->s, 168);
}
# 634 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void shake128_squeeze(uint8_t *out, size_t outlen, keccak_state *state)
{
  state->pos = keccak_squeeze(out, outlen, state->s, 168, state->pos);
}
# 647 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void shake256_init(keccak_state state[1])
{
  keccak_init(state);
}
# 662 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
...
# 674 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void shake256_finalize(keccak_state state[1])
{
  keccak_finalize(state->s, 136, state->pos, 0x1F);
  state->pos = 0;
}
# 693 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void shake256_squeezeblocks(uint8_t *out, size_t nblocks, keccak_state state[1])
{
  keccak_squeezeblocks(out, nblocks, state->s, 136);
}
# 709 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void shake256_squeeze(uint8_t *out, size_t outlen, keccak_state state[1])
{
  state->pos = keccak_squeeze(out, outlen, state->s, 136, state->pos);
}
# 724 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void shake128(uint8_t *out, size_t outlen, const uint8_t *in, size_t inlen)
{
  keccak_state state;
...
# 744 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void shake256(uint8_t out[3*32], size_t outlen, const uint8_t in[32], size_t inlen)
{
...
# 763 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void sha3_256(uint8_t h[32], const uint8_t *in, size_t inlen)
{
  uint64_t s[25] = {0};
  unsigned int pos;

  pos = keccak_absorb(s, 136, 0, in, inlen);
  keccak_finalize(s, 136, pos, 0x06);
  keccak_squeeze(h, 32, s, 136, 0);
}
# 782 "/home/guest/Documents/vlsi_2/area/cur/dilithium_2/fips202.c"
void sha3_512(uint8_t h[64], const uint8_t *in, size_t inlen)
{
  uint64_t s[25] = {0};
  unsigned int pos;

  pos = keccak_absorb(s, 72, 0, in, inlen);
  keccak_finalize(s, 72, pos, 0x06);
  keccak_squeeze(h, 64, s, 72, 0);
}
