...
architecture behav of polyveck_reduce is 
    ...
    signal i_15_fu_101_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_15_reg_166 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal grp_fu_141_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal trunc_ln_fu_127_p4 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_fu_141_p1 : STD_LOGIC_VECTOR (23 downto 0);
...
begin
    crypto_sign_mac_mibs_U50 : component crypto_sign_mac_mibs
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 9,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln32_fu_95_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                v_vec_coeffs_addr_reg_171 <= zext_ln33_1_fu_116_p1(10 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln187_fu_71_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    zext_ln28_reg_158(10 downto 8) <= zext_ln28_fu_91_p1(10 downto 8);
            end if;
        end if;
    end process;
    zext_ln28_reg_158(7 downto 0) <= "00000000";
    zext_ln28_reg_158(11) <= '0';
    ...
    add_ln33_fu_111_p2 <= std_logic_vector(unsigned(zext_ln28_reg_158) + unsigned(zext_ln33_fu_107_p1));
    ...
    i_15_fu_101_p2 <= std_logic_vector(unsigned(i_0_i_reg_60) + unsigned(ap_const_lv9_1));
    ...
    trunc_ln_fu_127_p4 <= add_ln36_fu_121_p2(31 downto 23);

    v_vec_coeffs_address0_assign_proc : process(ap_CS_fsm_state3, v_vec_coeffs_addr_reg_171, ap_CS_fsm_state4, zext_ln33_1_fu_116_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            v_vec_coeffs_address0 <= v_vec_coeffs_addr_reg_171;
