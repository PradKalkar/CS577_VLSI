...
architecture behav of ntt is 
    ...
    signal empty_53_fu_193_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    empty_53_fu_193_p2 <= "1" when (unsigned(j_reg_96) > unsigned(add_ln57_fu_184_p2)) else "0";
    ...
    start_fu_207_p3 <= 
        trunc_ln55_fu_199_p1 when (empty_53_fu_193_p2(0) = '1') else 
