...
architecture behav of ntt_1 is 
    ...
    signal empty_53_fu_215_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    empty_53_fu_215_p2 <= "1" when (unsigned(j_reg_110) > unsigned(add_ln57_fu_206_p2)) else "0";
    ...
    start_fu_229_p3 <= 
        trunc_ln55_fu_221_p1 when (empty_53_fu_215_p2(0) = '1') else 
