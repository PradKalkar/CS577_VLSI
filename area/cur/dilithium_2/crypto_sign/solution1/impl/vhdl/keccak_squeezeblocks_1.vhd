...
architecture behav of keccak_squeezeblocks_1 is 
    ...
    signal shl_ln16_fu_184_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal add_ln48_2_fu_210_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln48_5_fu_215_p1 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    add_ln48_2_fu_210_p2 <= std_logic_vector(unsigned(zext_ln48_4_fu_206_p1) + unsigned(shl_ln_reg_256));
    add_ln48_fu_219_p2 <= std_logic_vector(unsigned(p_0_rec_reg_82) + unsigned(zext_ln48_5_fu_215_p1));
    ...
    out_r_address0 <= zext_ln48_6_fu_225_p1(10 - 1 downto 0);
    ...
    shl_ln16_fu_184_p3 <= (trunc_ln48_fu_180_p1 & ap_const_lv3_0);
    ...
    zext_ln48_fu_192_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln16_fu_184_p3),64));
end behav;
