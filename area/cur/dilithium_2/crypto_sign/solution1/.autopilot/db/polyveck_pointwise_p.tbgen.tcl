set moduleName polyveck_pointwise_p
set isTopModule 0
...
set C_modelName {polyveck_pointwise_p}
set C_modelType { void 0 }
set C_modelArgList {
	{ r_vec_coeffs int 32 regular {array 1024 { 0 3 } 0 1 }  }
	{ a_coeffs int 32 regular {array 256 { 1 3 } 1 1 }  }
	{ v_vec_coeffs int 32 regular {array 1024 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "r_vec_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ r_vec_coeffs_address0 sc_out sc_lv 10 signal 0 } 
	{ r_vec_coeffs_ce0 sc_out sc_logic 1 signal 0 } 
	{ r_vec_coeffs_we0 sc_out sc_logic 1 signal 0 } 
	{ r_vec_coeffs_d0 sc_out sc_lv 32 signal 0 } 
	{ a_coeffs_address0 sc_out sc_lv 8 signal 1 } 
	{ a_coeffs_ce0 sc_out sc_logic 1 signal 1 } 
	{ a_coeffs_q0 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "r_vec_coeffs_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "r_vec_coeffs", "role": "address0" }} , 
 	{ "name": "r_vec_coeffs_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "r_vec_coeffs", "role": "ce0" }} , 
 	{ "name": "r_vec_coeffs_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "r_vec_coeffs", "role": "we0" }} , 
 	{ "name": "r_vec_coeffs_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "r_vec_coeffs", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	r_vec_coeffs { ap_memory {  { r_vec_coeffs_address0 mem_address 1 10 }  { r_vec_coeffs_ce0 mem_ce 1 1 }  { r_vec_coeffs_we0 mem_we 1 1 }  { r_vec_coeffs_d0 mem_din 1 32 } } }
