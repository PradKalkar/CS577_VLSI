...
set C_modelName {load64.2}
set C_modelType { int 64 }
set C_modelArgList {
	{ x int 8 regular {array 5720 { 1 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	x { ap_memory {  { x_address0 mem_address 1 13 }  { x_ce0 mem_ce 1 1 }  { x_q0 mem_dout 0 8 } } }
