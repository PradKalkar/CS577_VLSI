...
polyveck_caddq::polyveck_caddq(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_6_fu_119_p3 );

    SC_METHOD(thread_tmp_6_fu_119_p3);
    ...
    sc_trace(mVcdFile, tmp_6_fu_119_p3, "tmp_6_fu_119_p3");
...
void polyveck_caddq::thread_select_ln51_fu_127_p3() {
    select_ln51_fu_127_p3 = (!tmp_6_fu_119_p3.read()[0].is_01())? sc_lv<32>(): ((tmp_6_fu_119_p3.read()[0].to_bool())? ap_const_lv32_7FE001: ap_const_lv32_0);
}

void polyveck_caddq::thread_tmp_6_fu_119_p3() {
    tmp_6_fu_119_p3 = v_vec_coeffs_q0.read().range(31, 31);
}
