...
// ==============================================================
#ifndef __crypto_sign_urem_eOg__HH__
#define __crypto_sign_urem_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(crypto_sign_urem_eOg) {
    ...
    SC_CTOR(crypto_sign_urem_eOg):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
