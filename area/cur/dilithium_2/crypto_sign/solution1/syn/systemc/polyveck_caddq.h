...
#ifndef _polyveck_caddq_HH_
#define _polyveck_caddq_HH_
...
struct polyveck_caddq : public sc_module {
    ...
    // Module declarations
    polyveck_caddq(sc_module_name name);
    SC_HAS_PROCESS(polyveck_caddq);
    ...
    sc_signal< sc_lv<9> > i_19_fu_99_p2;
    sc_signal< sc_lv<9> > i_19_reg_158;
    ...
    sc_signal< sc_lv<1> > tmp_6_fu_119_p3;
