...
polyveck_reduce::polyveck_reduce(sc_module_name name) : sc_module(name), mVcdFile(0) {
    crypto_sign_mac_mibs_U50 = new crypto_sign_mac_mibs<1,1,9,24,32,32>("crypto_sign_mac_mibs_U50");
    crypto_sign_mac_mibs_U50->din0(trunc_ln_fu_127_p4);
    crypto_sign_mac_mibs_U50->din1(grp_fu_141_p1);
    crypto_sign_mac_mibs_U50->din2(v_vec_coeffs_q0);
    crypto_sign_mac_mibs_U50->dout(grp_fu_141_p3);
    ...
    SC_METHOD(thread_i_15_fu_101_p2);
    ...
    sc_trace(mVcdFile, i_15_fu_101_p2, "i_15_fu_101_p2");
    sc_trace(mVcdFile, i_15_reg_166, "i_15_reg_166");
...
polyveck_reduce::~polyveck_reduce() {
    ...
    delete crypto_sign_mac_mibs_U50;
}
...
void polyveck_reduce::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        i_0_i_reg_60 = i_15_reg_166.read();
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        i_15_reg_166 = i_15_fu_101_p2.read();
    }
...
void polyveck_reduce::thread_i_15_fu_101_p2() {
    i_15_fu_101_p2 = (!i_0_i_reg_60.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(i_0_i_reg_60.read()) + sc_biguint<9>(ap_const_lv9_1));
}
