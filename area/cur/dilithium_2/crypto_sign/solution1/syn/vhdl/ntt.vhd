...
architecture behav of ntt is 
    ...
    signal zext_ln54_2_fu_126_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal zext_ln54_2_reg_339 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal zext_ln54_3_fu_180_p1 : STD_LOGIC_VECTOR (28 downto 0);
    ...
    signal zext_ln55_2_fu_215_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal zext_ln55_2_reg_376 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal a_addr_15_reg_394 : STD_LOGIC_VECTOR (7 downto 0);
    signal j_2_fu_243_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal j_2_reg_400 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln55_fu_249_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal t_8_fu_310_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal t_8_reg_410 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_9_fu_170_p4 : STD_LOGIC_VECTOR (27 downto 0);
    signal add_ln57_fu_184_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal empty_54_fu_193_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln55_fu_199_p1 : STD_LOGIC_VECTOR (29 downto 0);
    signal trunc_ln55_2_fu_203_p1 : STD_LOGIC_VECTOR (29 downto 0);
    ...
    signal sext_ln58_2_fu_266_p1 : STD_LOGIC_VECTOR (55 downto 0);
    signal sext_ln19_7_fu_290_p1 : STD_LOGIC_VECTOR (55 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln55_fu_150_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                                len_0_reg_84(7 downto 0) <= zext_ln54_3_fu_180_p1(7 downto 0);
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
                len_0_reg_84(0) <= '0';
                len_0_reg_84(1) <= '0';
                len_0_reg_84(2) <= '0';
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln57_fu_223_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                a_addr_15_reg_394 <= zext_ln59_fu_238_p1(8 - 1 downto 0);
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                sext_ln57_reg_381 <= sext_ln57_fu_219_p1;
                    zext_ln55_2_reg_376(29 downto 0) <= zext_ln55_2_fu_215_p1(29 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                    zext_ln54_2_reg_339(7 downto 0) <= zext_ln54_2_fu_126_p1(7 downto 0);
    ...
    zext_ln54_2_reg_339(30 downto 8) <= "00000000000000000000000";
    zext_ln55_reg_348(31) <= '0';
    zext_ln57_reg_371(31) <= '0';
    zext_ln55_2_reg_376(30) <= '0';
    ...
    a_address0_assign_proc : process(a_addr_reg_389, ap_CS_fsm_state5, a_addr_15_reg_394, ap_CS_fsm_state6, ap_CS_fsm_state8, zext_ln58_fu_233_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
    ...
    a_address1_assign_proc : process(ap_CS_fsm_state5, a_addr_15_reg_394, zext_ln59_fu_238_p1, ap_CS_fsm_state7)
    begin
    ...
    add_ln19_fu_294_p2 <= std_logic_vector(signed(sext_ln58_2_fu_266_p1) + signed(sext_ln19_7_fu_290_p1));
    add_ln55_fu_249_p2 <= std_logic_vector(unsigned(zext_ln54_2_reg_339) + unsigned(zext_ln55_2_reg_376));
    add_ln57_fu_184_p2 <= std_logic_vector(unsigned(zext_ln54_2_reg_339) + unsigned(j_reg_96));
    add_ln58_fu_228_p2 <= std_logic_vector(unsigned(zext_ln54_reg_334) + unsigned(j_0_reg_108));
    add_ln60_fu_321_p2 <= std_logic_vector(signed(t_8_reg_410) + signed(a_q1));
    ...
    empty_54_fu_193_p2 <= "1" when (unsigned(j_reg_96) > unsigned(add_ln57_fu_184_p2)) else "0";
    ...
    j_2_fu_243_p2 <= std_logic_vector(unsigned(ap_const_lv32_1) + unsigned(j_0_reg_108));
    k_fu_159_p2 <= std_logic_vector(unsigned(ap_const_lv32_1) + unsigned(k_3_fu_42));
    ...
    mul_ln58_fu_261_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(mul_ln58_fu_261_p0) * signed(mul_ln58_fu_261_p1))), 54));
        sext_ln19_7_fu_290_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(mul_ln19_fu_284_p2),56));

        sext_ln57_fu_219_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(zetas_q0),54));

        sext_ln58_2_fu_266_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(mul_ln58_fu_261_p2),56));

    sext_ln58_fu_257_p0 <= a_q0;
    start_fu_207_p3 <= 
        trunc_ln55_fu_199_p1 when (empty_54_fu_193_p2(0) = '1') else 
        trunc_ln55_2_fu_203_p1;
    sub_ln59_fu_314_p2 <= std_logic_vector(unsigned(a_q1) - unsigned(t_8_fu_310_p1));
        t_8_fu_310_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_fu_300_p4),32));

    t_fu_274_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed('0' &ap_const_lv32_3802001) * signed(trunc_ln18_fu_270_p1))), 32));
    tmp_9_fu_170_p4 <= len_0_reg_84(28 downto 1);
    tmp_fu_140_p4 <= j_reg_96(30 downto 8);
    trunc_ln18_fu_270_p1 <= mul_ln58_fu_261_p2(32 - 1 downto 0);
    trunc_ln55_2_fu_203_p1 <= add_ln57_fu_184_p2(30 - 1 downto 0);
    ...
    zext_ln54_2_fu_126_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(len_0_reg_84),31));
    zext_ln54_3_fu_180_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_9_fu_170_p4),29));
    zext_ln54_fu_122_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(len_0_reg_84),32));
    zext_ln55_2_fu_215_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(start_fu_207_p3),31));
