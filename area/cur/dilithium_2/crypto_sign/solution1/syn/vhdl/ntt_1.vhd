...
architecture behav of ntt_1 is 
    ...
    signal a_addr_14_reg_394 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal k_2_fu_42 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_27_fu_170_p4 : STD_LOGIC_VECTOR (27 downto 0);
    signal add_ln57_fu_184_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal empty_63_fu_193_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    k_2_fu_42_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln57_fu_223_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                a_addr_14_reg_394 <= zext_ln59_fu_238_p1(8 - 1 downto 0);
    ...
    a_address0_assign_proc : process(a_addr_reg_389, ap_CS_fsm_state5, a_addr_14_reg_394, ap_CS_fsm_state6, ap_CS_fsm_state8, zext_ln58_fu_233_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
    ...
    a_address1_assign_proc : process(ap_CS_fsm_state5, a_addr_14_reg_394, zext_ln59_fu_238_p1, ap_CS_fsm_state7)
    begin
    ...
    empty_63_fu_193_p2 <= "1" when (unsigned(j_reg_96) > unsigned(add_ln57_fu_184_p2)) else "0";
    ...
    k_fu_159_p2 <= std_logic_vector(unsigned(ap_const_lv32_1) + unsigned(k_2_fu_42));
    ...
    start_fu_207_p3 <= 
        trunc_ln55_fu_199_p1 when (empty_63_fu_193_p2(0) = '1') else 
    ...
    tmp_27_fu_170_p4 <= len_0_reg_84(28 downto 1);
    ...
    zext_ln54_2_fu_180_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_27_fu_170_p4),29));
