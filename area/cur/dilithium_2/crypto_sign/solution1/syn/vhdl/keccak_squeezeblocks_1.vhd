...
architecture behav of keccak_squeezeblocks_1 is 
    ...
    signal i_39_fu_163_p2 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal zext_ln48_5_fu_210_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln48_fu_169_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal shl_ln19_fu_173_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln48_fu_181_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal lshr_ln48_fu_185_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln48_4_fu_195_p1 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln477_fu_126_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                p_0_rec_reg_83 <= add_ln479_fu_143_p2;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state4, icmp_ln477_fu_126_p2, ap_CS_fsm_state6, grp_KeccakF1600_StatePer_1_fu_118_ap_done, ap_phi_mux_p_01_phi_fu_75_p4, ap_CS_fsm_state3, icmp_ln47_fu_157_p2, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
    ...
    add_ln479_fu_143_p2 <= std_logic_vector(unsigned(p_0_rec_reg_83) + unsigned(ap_const_lv8_88));
    add_ln48_3_fu_199_p2 <= std_logic_vector(unsigned(zext_ln48_4_fu_195_p1) + unsigned(shl_ln_reg_233));
    ...
    i_39_fu_163_p2 <= std_logic_vector(unsigned(i_0_i_reg_107) + unsigned(ap_const_lv4_1));
    i_fu_132_p2 <= std_logic_vector(unsigned(i_0_reg_95) + unsigned(ap_const_lv5_1));
    icmp_ln477_fu_126_p2 <= "1" when (i_0_reg_95 = ap_const_lv5_11) else "0";
    ...
    out_r_address0 <= zext_ln48_5_fu_210_p1(8 - 1 downto 0);
    ...
    s_address0_assign_proc : process(ap_CS_fsm_state4, grp_KeccakF1600_StatePer_1_fu_118_state_address0, ap_CS_fsm_state3, zext_ln478_fu_138_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            s_address0 <= zext_ln478_fu_138_p1(5 - 1 downto 0);
    ...
    shl_ln19_fu_173_p3 <= (trunc_ln48_fu_169_p1 & ap_const_lv3_0);
    shl_ln_fu_149_p3 <= (i_0_reg_95 & ap_const_lv3_0);
    trunc_ln48_fu_169_p1 <= i_0_i_reg_107(3 - 1 downto 0);
    zext_ln478_fu_138_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_95),64));
    zext_ln48_4_fu_195_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_i_reg_107),8));
    zext_ln48_5_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln48_fu_204_p2),64));
    zext_ln48_fu_181_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln19_fu_173_p3),64));
end behav;
