...
wire   [8:0] i_25_fu_101_p2;
reg   [8:0] i_25_reg_166;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln32_fu_95_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        v_vec_coeffs_addr_reg_171 <= zext_ln33_1_fu_116_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln187_fu_71_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        zext_ln28_reg_158[10 : 8] <= zext_ln28_fu_91_p1[10 : 8];
    end
end
...
assign add_ln33_fu_111_p2 = (zext_ln28_reg_158 + zext_ln33_fu_107_p1);
...
assign i_25_fu_101_p2 = (i_0_i_reg_60 + 9'd1);
...
assign trunc_ln_fu_127_p4 = {{add_ln36_fu_121_p2[31:23]}};

assign v_vec_coeffs_d0 = grp_fu_141_p3;
...
always @ (posedge ap_clk) begin
    zext_ln28_reg_158[7:0] <= 8'b00000000;
    zext_ln28_reg_158[11] <= 1'b0;
end
