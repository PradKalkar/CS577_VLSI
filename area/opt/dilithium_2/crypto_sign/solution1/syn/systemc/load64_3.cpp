...
const sc_lv<3> load64_3::ap_ST_fsm_state1 = "1";
const sc_lv<3> load64_3::ap_ST_fsm_state2 = "10";
const sc_lv<3> load64_3::ap_ST_fsm_state3 = "100";
...
load64_3::load64_3(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( r_0_reg_53 );
    sensitive << ( shl_ln31_1_fu_115_p2 );

    SC_METHOD(thread_shl_ln31_1_fu_115_p2);
    sensitive << ( zext_ln31_1_fu_95_p1 );
    sensitive << ( zext_ln31_2_fu_111_p1 );

    SC_METHOD(thread_shl_ln_fu_103_p3);
    sensitive << ( trunc_ln31_2_fu_99_p1 );

    SC_METHOD(thread_trunc_ln31_2_fu_99_p1);
    sensitive << ( i_0_reg_41 );
    ...
    sc_trace(mVcdFile, trunc_ln31_2_fu_99_p1, "trunc_ln31_2_fu_99_p1");
    ...
    sc_trace(mVcdFile, shl_ln31_1_fu_115_p2, "shl_ln31_1_fu_115_p2");
...
void load64_3::thread_add_ln31_fu_85_p2() {
...
void load64_3::thread_i_fu_75_p2() {
    i_fu_75_p2 = (!i_0_reg_41.read().is_01() || !ap_const_lv4_1.is_01())? sc_lv<4>(): (sc_biguint<4>(i_0_reg_41.read()) + sc_biguint<4>(ap_const_lv4_1));
}

void load64_3::thread_icmp_ln30_fu_69_p2() {
    icmp_ln30_fu_69_p2 = (!i_0_reg_41.read().is_01() || !ap_const_lv4_8.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_41.read() == ap_const_lv4_8);
}

void load64_3::thread_r_fu_121_p2() {
    r_fu_121_p2 = (shl_ln31_1_fu_115_p2.read() | r_0_reg_53.read());
}

void load64_3::thread_shl_ln31_1_fu_115_p2() {
    shl_ln31_1_fu_115_p2 = (!zext_ln31_2_fu_111_p1.read().is_01())? sc_lv<64>(): zext_ln31_1_fu_95_p1.read() << (unsigned short)zext_ln31_2_fu_111_p1.read().to_uint();
}

void load64_3::thread_shl_ln_fu_103_p3() {
    shl_ln_fu_103_p3 = esl_concat<3,3>(trunc_ln31_2_fu_99_p1.read(), ap_const_lv3_0);
}

void load64_3::thread_trunc_ln31_2_fu_99_p1() {
    trunc_ln31_2_fu_99_p1 = i_0_reg_41.read().range(3-1, 0);
}

void load64_3::thread_trunc_ln31_fu_65_p1() {
...
void load64_3::thread_zext_ln31_1_fu_95_p1() {
    zext_ln31_1_fu_95_p1 = esl_zext<64,8>(x_q0.read());
}

void load64_3::thread_zext_ln31_2_fu_111_p1() {
    zext_ln31_2_fu_111_p1 = esl_zext<64,6>(shl_ln_fu_103_p3.read());
}

void load64_3::thread_zext_ln31_6_fu_90_p1() {
    zext_ln31_6_fu_90_p1 = esl_zext<64,14>(add_ln31_fu_85_p2.read());
}

void load64_3::thread_zext_ln31_fu_81_p1() {
