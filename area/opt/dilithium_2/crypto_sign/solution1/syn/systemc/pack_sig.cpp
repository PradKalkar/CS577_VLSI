...
pack_sig::pack_sig(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_i_36_fu_215_p2);
    sensitive << ( i_2_reg_125 );

    SC_METHOD(thread_i_37_fu_247_p2);
    ...
    sc_trace(mVcdFile, i_36_fu_215_p2, "i_36_fu_215_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, i_37_fu_247_p2, "i_37_fu_247_p2");
    sc_trace(mVcdFile, i_37_reg_391, "i_37_reg_391");
...
void pack_sig::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
        ...
        i_2_reg_125 = i_36_fu_215_p2.read();
    }
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        i_37_reg_391 = i_37_fu_247_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
...
void pack_sig::thread_i_36_fu_215_p2() {
    i_36_fu_215_p2 = (!i_2_reg_125.read().is_01() || !ap_const_lv7_1.is_01())? sc_lv<7>(): (sc_biguint<7>(i_2_reg_125.read()) + sc_biguint<7>(ap_const_lv7_1));
}

void pack_sig::thread_i_37_fu_247_p2() {
    i_37_fu_247_p2 = (!i_3_reg_136.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_biguint<3>(i_3_reg_136.read()) + sc_biguint<3>(ap_const_lv3_1));
}
