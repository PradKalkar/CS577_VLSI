...
polyveck_chknorm::polyveck_chknorm(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_i_28_fu_137_p2);
    ...
    sc_trace(mVcdFile, i_28_fu_137_p2, "i_28_fu_137_p2");
    sc_trace(mVcdFile, i_28_reg_218, "i_28_reg_218");
...
void polyveck_chknorm::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
        ...
        i_0_i_reg_80 = i_28_reg_218.read();
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        i_28_reg_218 = i_28_fu_137_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
...
void polyveck_chknorm::thread_i_28_fu_137_p2() {
    i_28_fu_137_p2 = (!i_0_i_reg_80.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(i_0_i_reg_80.read()) + sc_biguint<9>(ap_const_lv9_1));
}
...
void polyveck_chknorm::thread_t_fu_165_p3() {
    t_fu_165_p3 = (!tmp_8_fu_157_p3.read()[0].is_01())? sc_lv<32>(): ((tmp_8_fu_157_p3.read()[0].to_bool())? ap_const_lv32_FFFFFFFF: ap_const_lv32_0);
}

void polyveck_chknorm::thread_tmp_8_fu_157_p3() {
    tmp_8_fu_157_p3 = v_vec_coeffs_q0.read().range(31, 31);
}
