...
// ==============================================================
#ifndef __crypto_sign_mac_mvdy__HH__
#define __crypto_sign_mac_mvdy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(crypto_sign_mac_mvdy) {
    ...
    SC_CTOR(crypto_sign_mac_mvdy):  simcore_mac_1_U ("simcore_mac_1_U") {
