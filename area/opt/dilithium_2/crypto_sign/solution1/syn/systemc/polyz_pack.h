...
struct polyz_pack : public sc_module {
    ...
    sc_signal< sc_lv<8> > trunc_ln5_reg_719;
    sc_signal< sc_lv<8> > trunc_ln6_reg_724;
    sc_signal< sc_lv<8> > shl_ln_fu_338_p3;
    sc_signal< sc_lv<8> > shl_ln_reg_729;
    sc_signal< sc_logic > ap_CS_fsm_state4;
    sc_signal< sc_lv<8> > trunc_ln7_reg_740;
    sc_signal< sc_logic > ap_CS_fsm_state5;
    sc_signal< sc_lv<8> > trunc_ln8_reg_745;
    sc_signal< sc_logic > ap_CS_fsm_state6;
    sc_signal< sc_lv<8> > trunc_ln9_reg_755;
    sc_signal< sc_logic > ap_CS_fsm_state7;
    sc_signal< sc_lv<8> > trunc_ln_reg_760;
    sc_signal< sc_logic > ap_CS_fsm_state8;
    sc_signal< sc_lv<8> > trunc_ln1_reg_770;
    sc_signal< sc_logic > ap_CS_fsm_state9;
    sc_signal< sc_lv<8> > trunc_ln2_reg_775;
