...
const sc_logic polyveck_caddq::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic polyveck_caddq::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<4> polyveck_caddq::ap_ST_fsm_state1 = "1";
const sc_lv<4> polyveck_caddq::ap_ST_fsm_state2 = "10";
const sc_lv<4> polyveck_caddq::ap_ST_fsm_state3 = "100";
const sc_lv<4> polyveck_caddq::ap_ST_fsm_state4 = "1000";
const sc_lv<32> polyveck_caddq::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<32> polyveck_caddq::ap_const_lv32_1 = "1";
const sc_lv<1> polyveck_caddq::ap_const_lv1_0 = "0";
const sc_lv<32> polyveck_caddq::ap_const_lv32_2 = "10";
const sc_lv<3> polyveck_caddq::ap_const_lv3_0 = "000";
const sc_lv<1> polyveck_caddq::ap_const_lv1_1 = "1";
const sc_lv<9> polyveck_caddq::ap_const_lv9_0 = "000000000";
const sc_lv<32> polyveck_caddq::ap_const_lv32_3 = "11";
const sc_lv<3> polyveck_caddq::ap_const_lv3_4 = "100";
const sc_lv<3> polyveck_caddq::ap_const_lv3_1 = "1";
const sc_lv<8> polyveck_caddq::ap_const_lv8_0 = "00000000";
const sc_lv<9> polyveck_caddq::ap_const_lv9_100 = "100000000";
const sc_lv<9> polyveck_caddq::ap_const_lv9_1 = "1";
const sc_lv<32> polyveck_caddq::ap_const_lv32_1F = "11111";
const sc_lv<32> polyveck_caddq::ap_const_lv32_7FE001 = "11111111110000000000001";
const bool polyveck_caddq::ap_const_boolean_1 = true;

polyveck_caddq::polyveck_caddq(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_i_29_fu_99_p2);
    ...
    apTFilenSS << "polyveck_caddq_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, i_29_fu_99_p2, "i_29_fu_99_p2");
    sc_trace(mVcdFile, i_29_reg_158, "i_29_reg_158");
...
void polyveck_caddq::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        i_0_i_reg_58 = i_29_reg_158.read();
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        i_29_reg_158 = i_29_fu_99_p2.read();
    }
...
void polyveck_caddq::thread_add_ln51_fu_109_p2() {
...
void polyveck_caddq::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void polyveck_caddq::thread_ap_CS_fsm_state2() {
    ap_CS_fsm_state2 = ap_CS_fsm.read()[1];
}

void polyveck_caddq::thread_ap_CS_fsm_state3() {
    ap_CS_fsm_state3 = ap_CS_fsm.read()[2];
}

void polyveck_caddq::thread_ap_CS_fsm_state4() {
    ap_CS_fsm_state4 = ap_CS_fsm.read()[3];
}

void polyveck_caddq::thread_ap_done() {
...
void polyveck_caddq::thread_ap_idle() {
    if ((esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
...
void polyveck_caddq::thread_ap_ready() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
         esl_seteq<1,1,1>(icmp_ln202_fu_69_p2.read(), ap_const_lv1_1))) {
...
void polyveck_caddq::thread_i_29_fu_99_p2() {
    i_29_fu_99_p2 = (!i_0_i_reg_58.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(i_0_i_reg_58.read()) + sc_biguint<9>(ap_const_lv9_1));
}
...
void polyveck_caddq::thread_v_vec_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
...
void polyveck_caddq::thread_v_vec_coeffs_ce0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) || 
...
void polyveck_caddq::thread_v_vec_coeffs_d0() {
...
void polyveck_caddq::thread_v_vec_coeffs_we0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
...
void polyveck_caddq::thread_zext_ln46_fu_89_p1() {
    zext_ln46_fu_89_p1 = esl_zext<12,11>(tmp_fu_81_p3.read());
}

void polyveck_caddq::thread_zext_ln51_1_fu_114_p1() {
    zext_ln51_1_fu_114_p1 = esl_zext<64,12>(add_ln51_fu_109_p2.read());
}

void polyveck_caddq::thread_zext_ln51_fu_105_p1() {
    zext_ln51_fu_105_p1 = esl_zext<12,9>(i_0_i_reg_58.read());
}

void polyveck_caddq::thread_ap_NS_fsm() {
