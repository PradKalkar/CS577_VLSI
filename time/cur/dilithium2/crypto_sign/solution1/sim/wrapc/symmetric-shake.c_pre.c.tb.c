...
// ==============================================================
# 1 "/media/storage/Time/dilithium2/symmetric-shake.c"
# 1 "/media/storage/Time/dilithium2/symmetric-shake.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/media/storage/Time/dilithium2/symmetric-shake.c" 2
...
# 2 "/media/storage/Time/dilithium2/symmetric-shake.c" 2
...
# 3 "/media/storage/Time/dilithium2/symmetric-shake.c" 2
...
void pqcrystals_dilithium2_ref_dilithium_shake256_stream_init(keccak_state *state,
                                    ...
                                    uint16_t nonce);
# 4 "/media/storage/Time/dilithium2/symmetric-shake.c" 2
