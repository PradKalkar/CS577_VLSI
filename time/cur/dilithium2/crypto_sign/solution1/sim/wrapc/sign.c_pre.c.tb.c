...
// ==============================================================
# 1 "/home/cse/Downloads/time/dilithium2/sign.c"
# 1 "/home/cse/Downloads/time/dilithium2/sign.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/cse/Downloads/time/dilithium2/sign.c" 2
...
# 2 "/home/cse/Downloads/time/dilithium2/sign.c" 2
...
# 3 "/home/cse/Downloads/time/dilithium2/sign.c" 2
# 1 "/home/cse/Downloads/time/dilithium2/sign.h" 1
...
typedef int wchar_t;
# 5 "/home/cse/Downloads/time/dilithium2/sign.h" 2
...
# 8 "/home/cse/Downloads/time/dilithium2/sign.h" 2
...
int pqcrystals_dilithium2_ref_open(uint8_t *m, size_t *mlen,
                     ...
                     const uint8_t *pk);
# 4 "/home/cse/Downloads/time/dilithium2/sign.c" 2
...
# 5 "/home/cse/Downloads/time/dilithium2/sign.c" 2


# 1 "/home/cse/Downloads/time/dilithium2/randombytes.h" 1



# 1 "/tools/Xilinx/Vivado/2019.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 1 3
# 5 "/home/cse/Downloads/time/dilithium2/randombytes.h" 2


void randombytes(uint8_t *out, size_t outlen);
# 8 "/home/cse/Downloads/time/dilithium2/sign.c" 2
...
void pqcrystals_dilithium2_ref_dilithium_shake256_stream_init(keccak_state *state,
                                    const uint8_t seed[48],
                                    uint16_t nonce);
# 9 "/home/cse/Downloads/time/dilithium2/sign.c" 2
# 23 "/home/cse/Downloads/time/dilithium2/sign.c"
int pqcrystals_dilithium2_ref_keypair(uint8_t *pk, uint8_t *sk) {
...
# 80 "/home/cse/Downloads/time/dilithium2/sign.c"
...
# 197 "/home/cse/Downloads/time/dilithium2/sign.c"
...
# 228 "/home/cse/Downloads/time/dilithium2/sign.c"
...
# 310 "/home/cse/Downloads/time/dilithium2/sign.c"
