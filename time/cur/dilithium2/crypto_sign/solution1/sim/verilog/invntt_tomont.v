...
always @ (posedge ap_clk) begin
    if (((tmp_104_fu_179_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        j_1_reg_147 <= 9'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_104_fu_179_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        j_reg_126 <= 10'd0;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln86_fu_274_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        a_addr_511_reg_555 <= zext_ln88_3_fu_312_p1;
...
assign empty_88_fu_242_p2 = ((j_reg_126 > add_ln86_fu_233_p2) ? 1'b1 : 1'b0);

assign icmp_ln84_fu_201_p2 = ((tmp_105_fu_191_p4 == 2'd0) ? 1'b1 : 1'b0);
...
assign k_fu_210_p2 = ($signed(32'd4294967295) + $signed(k_3_fu_58));
...
assign start_fu_258_p3 = ((empty_88_fu_242_p2[0:0] === 1'b1) ? trunc_ln84_fu_248_p1 : add_ln84_1_fu_252_p2);

assign sub_ln89_fu_338_p2 = (t_reg_571 - a_q1);

assign t_10_fu_481_p1 = $signed(trunc_ln_fu_471_p4);

assign t_11_fu_360_p2 = ($signed({{1'b0}, {32'd58728449}}) * $signed(trunc_ln18_3_fu_356_p1));
...
assign tmp_104_fu_179_p3 = len_0_reg_114[32'd8];

assign tmp_105_fu_191_p4 = {{j_reg_126[9:8]}};

assign tmp_fu_158_p3 = {{a_offset}, {8'd0}};

assign trunc_ln18_3_fu_356_p1 = mul_ln90_fu_347_p2[31:0];
