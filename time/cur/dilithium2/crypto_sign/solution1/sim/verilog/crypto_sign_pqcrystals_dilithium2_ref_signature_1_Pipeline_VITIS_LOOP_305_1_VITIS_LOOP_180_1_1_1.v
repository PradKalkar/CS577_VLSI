...
module crypto_sign_pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_305_1_VITIS_LOOP_180_1_1_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
wire   [63:0] zext_ln181_1_fu_200_p1;
reg   [63:0] zext_ln181_1_reg_305;
wire    ap_block_pp0_stage0_11001;
wire    ap_block_pp0_stage0;
wire   [63:0] i_43_cast_fu_185_p1;
reg   [8:0] i_fu_58;
wire   [8:0] add_ln180_fu_205_p2;
wire    ap_loop_init;
reg   [8:0] ap_sig_allocacmp_i_load;
reg   [2:0] i_15_fu_62;
wire   [2:0] select_ln305_1_fu_165_p3;
reg   [2:0] ap_sig_allocacmp_i_15_load;
reg   [10:0] indvar_flatten83_fu_66;
wire   [10:0] add_ln305_1_fu_133_p2;
reg   [10:0] ap_sig_allocacmp_indvar_flatten83_load;
wire   [0:0] icmp_ln180_fu_151_p2;
wire   [2:0] add_ln305_fu_145_p2;
...
wire  signed [63:0] sext_ln19_10_fu_260_p1;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln305_fu_127_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        zext_ln181_1_reg_305[9 : 0] <= zext_ln181_1_fu_200_p1[9 : 0];
    end
end
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_i_15_load = 3'd0;
    end else begin
...
assign add_ln19_fu_264_p2 = ($signed(sext_ln19_10_fu_260_p1) + $signed(mul_ln181_fu_234_p2));

assign add_ln305_1_fu_133_p2 = (ap_sig_allocacmp_indvar_flatten83_load + 11'd1);

assign add_ln305_fu_145_p2 = (ap_sig_allocacmp_i_15_load + 3'd1);
...
assign cp_coeffs_address0 = i_43_cast_fu_185_p1;

assign h_vec_coeffs_address0 = zext_ln181_1_reg_305;

assign h_vec_coeffs_d0 = {{add_ln19_fu_264_p2[63:32]}};

assign i_43_cast_fu_185_p1 = select_ln305_fu_157_p3;

assign icmp_ln180_fu_151_p2 = ((ap_sig_allocacmp_i_load == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln305_fu_127_p2 = ((ap_sig_allocacmp_indvar_flatten83_load == 11'd1024) ? 1'b1 : 1'b0);

assign mul_ln19_fu_254_p1 = 55'd36028797010583551;

assign s2_vec_coeffs_address0 = zext_ln181_1_fu_200_p1;

assign select_ln305_1_fu_165_p3 = ((icmp_ln180_fu_151_p2[0:0] == 1'b1) ? add_ln305_fu_145_p2 : ap_sig_allocacmp_i_15_load);

assign select_ln305_fu_157_p3 = ((icmp_ln180_fu_151_p2[0:0] == 1'b1) ? 9'd0 : ap_sig_allocacmp_i_load);

assign sext_ln19_10_fu_260_p1 = $signed(mul_ln19_fu_254_p2);
...
assign trunc_ln181_fu_173_p1 = select_ln305_1_fu_165_p3[1:0];

assign zext_ln181_1_fu_200_p1 = add_ln181_fu_194_p2;

assign zext_ln181_fu_190_p1 = select_ln305_fu_157_p3;

always @ (posedge ap_clk) begin
    zext_ln181_1_reg_305[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
end

endmodule //crypto_sign_pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_305_1_VITIS_LOOP_180_1_1_1
