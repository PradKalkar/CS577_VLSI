; ModuleID = '/home/guest/Documents/vlsi/dilithium2/crypto_sign/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define i32 @apatb_crypto_sign_ir(i8* noalias nocapture nonnull "fpga.decayed.dim.hint"="5720" %sm, i64* noalias nocapture nonnull %smlen, i8* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="3300" %m, i64 %mlen, i8* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="2544" %sk) local_unnamed_addr #0 {
entry:
  ...
  %5 = call i32 @apatb_crypto_sign_hw(i8* %malloccall, i64* %smlen_copy, i8* %3, i64 %mlen, i8* %4)
...
declare i32 @apatb_crypto_sign_hw(i8*, i64*, i8*, i64, i8*)
...
define i32 @crypto_sign_hw_stub_wrapper(i8*, i64*, i8*, i64, i8*) #4 {
entry:
