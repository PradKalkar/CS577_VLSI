...
// ==============================================================
# 1 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c"
# 1 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c" 2
...
# 1 "/media/storage/Vivado/2019.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 1 3 4
# 31 "/media/storage/Vivado/2019.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 3 4
...
# 1 "/media/storage/Vivado/2019.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 1 3 4
# 30 "/media/storage/Vivado/2019.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 48 "/media/storage/Vivado/2019.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 3 4
...
# 9 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c" 2
...
# 10 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 11 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c" 2
...
# 12 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c" 2
# 1 "/media/storage/Time/dilithium2/rng.h" 1
# 18 "/media/storage/Time/dilithium2/rng.h"
typedef struct {
...
# 13 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c" 2
# 1 "/media/storage/Time/dilithium2/api.h" 1



# 1 "/media/storage/Time/dilithium2/config.h" 1
# 5 "/media/storage/Time/dilithium2/api.h" 2
# 23 "/media/storage/Time/dilithium2/api.h"
...
# 14 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c" 2
...
# 36 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c"
...
#endif
# 44 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c"
int
main()
{
    ...
    unsigned char m[3300], sm[3300+2420], m1[3300+2420];
    unsigned long long mlen, smlen, mlen1;
    int count;
    int done;
    unsigned char pk[1312], sk[2544];
    int ret_val;
    int i;


    sprintf(fn_req, "PQCsignKAT_%d.req", 2544);
    if ( (fp_req = fopen(fn_req, "w")) == ((void*)0) ) {
        printf("Couldn't open <%s> for write\n", fn_req);
        return -1;
    }
    sprintf(fn_rsp, "PQCsignKAT_%d.rsp", 2544);
    if ( (fp_rsp = fopen(fn_rsp, "w")) == ((void*)0) ) {
        printf("Couldn't open <%s> for write\n", fn_rsp);
        return -1;
    }
    ...
    randombytes_init(entropy_input, ((void*)0), 256);
    for (i=0; i<2; i++) {
    ...
    if ( (fp_req = fopen(fn_req, "r")) == ((void*)0) ) {
    ...
    do {
        ...
        fprintBstr(fp_rsp, "pk = ", pk, 1312);
        fprintBstr(fp_rsp, "sk = ", sk, 2544);

        if ( (ret_val = 
#ifndef HLS_FASTSIM
#define crypto_sign AESL_WRAP_crypto_sign
#endif
# 142 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c"
...
# 179 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c"
    fclose(fp_req);
    fclose(fp_rsp);
...
#endif
# 183 "/media/storage/Time/dilithium2/PQCgenKAT_sign.c"
