...
module crypto_sign_pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_57_310 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire  signed [53:0] sext_ln57_1_cast_fu_107_p1;
reg  signed [53:0] sext_ln57_1_cast_reg_253;
reg   [9:0] s2_vec_coeffs_addr_1_reg_261;
reg   [9:0] s2_vec_coeffs_addr_reg_267;
wire  signed [31:0] sext_ln19_fu_229_p1;
reg  signed [31:0] sext_ln19_reg_273;
wire    ap_CS_fsm_state2;
wire    ap_block_state2_pp0_stage1_iter0;
wire   [63:0] zext_ln59_fu_143_p1;
wire   [63:0] zext_ln58_fu_160_p1;
reg   [10:0] j_fu_48;
wire   [10:0] zext_ln57_1_cast_fu_115_p1;
wire   [10:0] add_ln57_fu_165_p2;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_j_6;
...
wire   [9:0] zext_ln50_3_cast_fu_111_p1;
wire   [9:0] add_ln58_1_fu_148_p2;
wire   [9:0] add_ln58_fu_154_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln57_fu_127_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        s2_vec_coeffs_addr_1_reg_261 <= zext_ln59_fu_143_p1;
        s2_vec_coeffs_addr_reg_267 <= zext_ln58_fu_160_p1;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        s2_vec_coeffs_address0 = zext_ln59_fu_143_p1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        s2_vec_coeffs_address1 = zext_ln58_fu_160_p1;
    end else begin
...
assign add_ln19_fu_213_p2 = ($signed(sext_ln19_4_fu_209_p1) + $signed(sext_ln15_fu_185_p1));

assign add_ln57_fu_165_p2 = (ap_sig_allocacmp_j_6 + 11'd1);

assign add_ln58_1_fu_148_p2 = (zext_ln58_6 + zext_ln50_3_cast_fu_111_p1);

assign add_ln58_fu_154_p2 = (add_ln58_1_fu_148_p2 + trunc_ln59_fu_133_p1);

assign add_ln59_fu_137_p2 = (zext_ln58_6 + trunc_ln59_fu_133_p1);

assign add_ln60_fu_240_p2 = ($signed(s2_vec_coeffs_q1) + $signed(sext_ln19_reg_273));
...
assign icmp_ln57_fu_127_p2 = ((ap_sig_allocacmp_j_6 == add_ln57_6) ? 1'b1 : 1'b0);

assign mul_ln19_fu_203_p1 = 55'd36028797010583551;

assign mul_ln58_fu_180_p1 = sext_ln57_1_cast_reg_253;

assign sext_ln15_fu_185_p1 = mul_ln58_fu_180_p2;

assign sext_ln19_4_fu_209_p1 = $signed(mul_ln19_fu_203_p2);

assign sext_ln19_fu_229_p1 = $signed(t_7_fu_219_p4);

assign sext_ln57_1_cast_fu_107_p1 = $signed(sext_ln57_1);

assign sub_ln59_fu_233_p2 = ($signed(s2_vec_coeffs_q0) - $signed(sext_ln19_fu_229_p1));

assign t_7_fu_219_p4 = {{add_ln19_fu_213_p2[55:32]}};

assign t_fu_193_p0 = mul_ln58_fu_180_p2[31:0];

assign t_fu_193_p1 = 32'd58728449;

assign trunc_ln59_fu_133_p1 = ap_sig_allocacmp_j_6[9:0];

assign zext_ln50_3_cast_fu_111_p1 = zext_ln50_3;

assign zext_ln57_1_cast_fu_115_p1 = zext_ln57_1;

assign zext_ln58_fu_160_p1 = add_ln58_fu_154_p2;

assign zext_ln59_fu_143_p1 = add_ln59_fu_137_p2;

endmodule //crypto_sign_pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_57_310
