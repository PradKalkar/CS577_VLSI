...
// ==============================================================
#ifndef __crypto_sign_mac_mkbM__HH__
#define __crypto_sign_mac_mkbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(crypto_sign_mac_mkbM) {
    ...
    SC_CTOR(crypto_sign_mac_mkbM):  simcore_mac_2_U ("simcore_mac_2_U") {
