...
ntt::ntt(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_empty_59_fu_215_p2);
    ...
    SC_METHOD(thread_tmp_100_fu_162_p4);
    sensitive << ( j_reg_110 );

    SC_METHOD(thread_tmp_101_fu_192_p4);
    sensitive << ( len_0_reg_98 );
    ...
    sc_trace(mVcdFile, tmp_100_fu_162_p4, "tmp_100_fu_162_p4");
    sc_trace(mVcdFile, tmp_101_fu_192_p4, "tmp_101_fu_192_p4");
    sc_trace(mVcdFile, add_ln57_fu_206_p2, "add_ln57_fu_206_p2");
    sc_trace(mVcdFile, empty_59_fu_215_p2, "empty_59_fu_215_p2");
...
void ntt::thread_empty_59_fu_215_p2() {
    empty_59_fu_215_p2 = (!j_reg_110.read().is_01() || !add_ln57_fu_206_p2.read().is_01())? sc_lv<1>(): (sc_biguint<31>(j_reg_110.read()) > sc_biguint<31>(add_ln57_fu_206_p2.read()));
}
...
void ntt::thread_icmp_ln55_fu_172_p2() {
    icmp_ln55_fu_172_p2 = (!tmp_100_fu_162_p4.read().is_01() || !ap_const_lv23_0.is_01())? sc_lv<1>(): sc_lv<1>(tmp_100_fu_162_p4.read() == ap_const_lv23_0);
}
...
void ntt::thread_start_fu_229_p3() {
    start_fu_229_p3 = (!empty_59_fu_215_p2.read()[0].is_01())? sc_lv<30>(): ((empty_59_fu_215_p2.read()[0].to_bool())? trunc_ln55_fu_221_p1.read(): trunc_ln55_2_fu_225_p1.read());
}
...
void ntt::thread_tmp_100_fu_162_p4() {
    tmp_100_fu_162_p4 = j_reg_110.read().range(30, 8);
}

void ntt::thread_tmp_101_fu_192_p4() {
    tmp_101_fu_192_p4 = len_0_reg_98.read().range(28, 1);
}
...
void ntt::thread_zext_ln54_3_fu_202_p1() {
    zext_ln54_3_fu_202_p1 = esl_zext<29,28>(tmp_101_fu_192_p4.read());
}
