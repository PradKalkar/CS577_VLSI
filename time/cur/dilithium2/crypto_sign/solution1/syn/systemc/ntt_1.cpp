...
ntt_1::ntt_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_empty_58_fu_193_p2);
    ...
    SC_METHOD(thread_tmp_99_fu_170_p4);
    sensitive << ( len_0_reg_84 );
    ...
    sc_trace(mVcdFile, a_addr_233_reg_394, "a_addr_233_reg_394");
    ...
    sc_trace(mVcdFile, k_1_fu_42, "k_1_fu_42");
    ...
    sc_trace(mVcdFile, tmp_99_fu_170_p4, "tmp_99_fu_170_p4");
    sc_trace(mVcdFile, add_ln57_fu_184_p2, "add_ln57_fu_184_p2");
    sc_trace(mVcdFile, empty_58_fu_193_p2, "empty_58_fu_193_p2");
...
void ntt_1::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln57_fu_223_p2.read()))) {
        a_addr_233_reg_394 =  (sc_lv<8>) (zext_ln59_fu_238_p1.read());
...
void ntt_1::thread_a_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        a_address0 = a_addr_233_reg_394.read();
...
void ntt_1::thread_a_address1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        a_address1 = a_addr_233_reg_394.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
...
void ntt_1::thread_empty_58_fu_193_p2() {
    empty_58_fu_193_p2 = (!j_reg_96.read().is_01() || !add_ln57_fu_184_p2.read().is_01())? sc_lv<1>(): (sc_biguint<31>(j_reg_96.read()) > sc_biguint<31>(add_ln57_fu_184_p2.read()));
}
...
void ntt_1::thread_k_fu_159_p2() {
    k_fu_159_p2 = (!ap_const_lv32_1.is_01() || !k_1_fu_42.read().is_01())? sc_lv<32>(): (sc_biguint<32>(ap_const_lv32_1) + sc_biguint<32>(k_1_fu_42.read()));
}
...
void ntt_1::thread_start_fu_207_p3() {
    start_fu_207_p3 = (!empty_58_fu_193_p2.read()[0].is_01())? sc_lv<30>(): ((empty_58_fu_193_p2.read()[0].to_bool())? trunc_ln55_fu_199_p1.read(): trunc_ln55_1_fu_203_p1.read());
}
...
void ntt_1::thread_tmp_99_fu_170_p4() {
    tmp_99_fu_170_p4 = len_0_reg_84.read().range(28, 1);
}
...
void ntt_1::thread_trunc_ln18_2_fu_270_p1() {
...
void ntt_1::thread_zext_ln54_2_fu_180_p1() {
    zext_ln54_2_fu_180_p1 = esl_zext<29,28>(tmp_99_fu_170_p4.read());
}
