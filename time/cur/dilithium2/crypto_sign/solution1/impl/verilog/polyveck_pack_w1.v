...
wire   [1:0] trunc_ln421_fu_173_p1;
wire   [9:0] shl_ln_fu_177_p3;
wire   [7:0] shl_ln421_1_fu_189_p3;
wire   [10:0] zext_ln421_fu_185_p1;
wire   [10:0] zext_ln421_1_fu_197_p1;
wire   [10:0] sub_ln421_fu_201_p2;
wire   [5:0] trunc_ln916_fu_227_p1;
wire   [10:0] tmp_s_fu_239_p4;
wire   [7:0] or_ln917_fu_254_p2;
wire   [10:0] tmp_260_fu_260_p3;
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln420_fu_161_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        i_0_i_reg_150 <= 7'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln420_fu_161_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln915_fu_215_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        shl_ln1_reg_489[7 : 2] <= shl_ln1_fu_231_p3[7 : 2];
    end
end
...
always @ (*) begin
    if ((((icmp_ln420_fu_161_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln420_fu_161_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
assign icmp_ln420_fu_161_p2 = ((i_0_reg_138 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln915_fu_215_p2 = ((i_0_i_reg_150 == 7'd64) ? 1'b1 : 1'b0);

assign or_ln917_1_fu_315_p2 = (trunc_ln916_1_fu_276_p1 | shl_ln2_fu_307_p3);

assign or_ln917_fu_254_p2 = (shl_ln1_fu_231_p3 | 8'd1);

assign or_ln919_1_fu_403_p2 = (trunc_ln9_reg_512 | shl_ln3_fu_395_p3);

assign or_ln919_fu_332_p2 = (shl_ln1_reg_489 | 8'd2);

assign or_ln921_fu_350_p2 = (shl_ln1_reg_489 | 8'd3);

assign r_address1 = zext_ln920_fu_437_p1;

assign r_d1 = (trunc_ln_fu_409_p4 | shl_ln4_fu_446_p3);

assign sext_ln910_fu_207_p1 = $signed(sub_ln421_fu_201_p2);
...
assign shl_ln1_fu_231_p3 = {{trunc_ln916_fu_227_p1}, {2'd0}};

assign shl_ln2_fu_307_p3 = {{trunc_ln917_fu_303_p1}, {6'd0}};

assign shl_ln3_fu_395_p3 = {{trunc_ln919_fu_391_p1}, {4'd0}};

assign shl_ln421_1_fu_189_p3 = {{trunc_ln421_fu_173_p1}, {6'd0}};

assign shl_ln4_fu_446_p3 = {{trunc_ln921_fu_442_p1}, {2'd0}};

assign shl_ln_fu_177_p3 = {{trunc_ln421_fu_173_p1}, {8'd0}};

assign sub_ln421_fu_201_p2 = (zext_ln421_fu_185_p1 - zext_ln421_1_fu_197_p1);

assign sub_ln916_fu_280_p2 = (zext_ln916_fu_273_p1 - zext_ln915_reg_476);

assign tmp_260_fu_260_p3 = {{i_0_reg_138}, {or_ln917_fu_254_p2}};

assign tmp_261_fu_337_p3 = {{i_0_reg_138}, {or_ln919_fu_332_p2}};

assign tmp_262_fu_355_p3 = {{i_0_reg_138}, {or_ln921_fu_350_p2}};

assign tmp_s_fu_239_p4 = {{{i_0_reg_138}, {trunc_ln916_fu_227_p1}}, {2'd0}};

assign trunc_ln421_fu_173_p1 = i_0_reg_138[1:0];
...
assign zext_ln421_1_fu_197_p1 = shl_ln421_1_fu_189_p3;

assign zext_ln421_fu_185_p1 = shl_ln_fu_177_p3;

assign zext_ln915_fu_211_p1 = i_0_i_reg_150;

assign zext_ln916_1_fu_249_p1 = tmp_s_fu_239_p4;

assign zext_ln916_2_fu_298_p1 = $unsigned(sext_ln916_1_fu_294_p1);

assign zext_ln916_fu_273_p1 = shl_ln1_reg_489;

assign zext_ln917_fu_268_p1 = tmp_260_fu_260_p3;

assign zext_ln918_fu_386_p1 = $unsigned(sext_ln918_1_fu_382_p1);

assign zext_ln919_fu_345_p1 = tmp_261_fu_337_p3;

assign zext_ln920_fu_437_p1 = $unsigned(sext_ln920_1_fu_433_p1);

assign zext_ln921_fu_363_p1 = tmp_262_fu_355_p3;

always @ (posedge ap_clk) begin
    sext_ln910_reg_469[5:0] <= 6'b000000;
    zext_ln915_reg_476[8:7] <= 2'b00;
    shl_ln1_reg_489[1:0] <= 2'b00;
end
