...
module crypto_sign_pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_95_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg   [9:0] z_vec_coeffs_addr_reg_180;
wire    ap_block_pp0_stage0_11001;
wire   [63:0] zext_ln96_1_fu_101_p1;
...
crypto_sign_mul_32s_17ns_49_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 17 ),
    .dout_WIDTH( 49 ))
mul_32s_17ns_49_1_1_U279(
...
always @ (posedge ap_clk) begin
    if (((icmp_ln95_fu_79_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        z_vec_coeffs_addr_reg_180 <= zext_ln96_1_fu_101_p1;
    end
end
...
assign add_ln19_fu_149_p2 = ($signed(sext_ln19_1_fu_145_p1) + $signed(sext_ln15_fu_121_p1));

assign add_ln95_fu_85_p2 = (ap_sig_allocacmp_j_1 + 9'd1);
...
assign icmp_ln95_fu_79_p2 = ((ap_sig_allocacmp_j_1 == 9'd256) ? 1'b1 : 1'b0);
...
assign sext_ln19_1_fu_145_p1 = $signed(mul_ln19_fu_139_p2);

assign t_1_fu_155_p4 = {{add_ln19_fu_149_p2[55:32]}};

assign t_fu_129_p0 = mul_ln96_fu_115_p2[31:0];

assign t_fu_129_p1 = 32'd58728449;

assign z_vec_coeffs_address0 = z_vec_coeffs_addr_reg_180;

assign z_vec_coeffs_address1 = zext_ln96_1_fu_101_p1;

assign z_vec_coeffs_d0 = $signed(t_1_fu_155_p4);

assign zext_ln96_1_fu_101_p1 = add_ln96_fu_95_p2;

assign zext_ln96_fu_91_p1 = ap_sig_allocacmp_j_1;

endmodule //crypto_sign_pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_95_4
