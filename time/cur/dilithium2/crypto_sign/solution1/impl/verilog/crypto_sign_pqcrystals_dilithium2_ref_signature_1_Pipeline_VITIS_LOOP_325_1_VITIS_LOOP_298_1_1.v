...
module crypto_sign_pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_325_1_VITIS_LOOP_298_1_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [10:0] add_ln325_fu_119_p2;
reg   [10:0] add_ln325_reg_269;
wire   [8:0] select_ln325_fu_143_p3;
reg   [8:0] select_ln325_reg_274;
wire   [2:0] select_ln325_2_fu_151_p3;
reg   [2:0] select_ln325_2_reg_279;
reg   [0:0] ap_phi_mux_merge_phi_fu_87_p4;
wire   [63:0] zext_ln300_2_fu_181_p1;
reg   [8:0] i_fu_58;
wire   [8:0] add_ln298_fu_226_p2;
wire    ap_loop_init;
reg   [8:0] ap_sig_allocacmp_i_load;
reg   [2:0] i_14_fu_62;
reg   [2:0] ap_sig_allocacmp_i_14_load;
reg   [10:0] indvar_flatten125_fu_66;
reg   [10:0] ap_sig_allocacmp_indvar_flatten125_load;
wire   [0:0] icmp_ln298_fu_137_p2;
wire   [2:0] add_ln325_1_fu_131_p2;
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_sig_allocacmp_i_14_load = 3'd0;
    end else begin
...
assign add_ln325_1_fu_131_p2 = (ap_sig_allocacmp_i_14_load + 3'd1);

assign add_ln325_fu_119_p2 = (ap_sig_allocacmp_indvar_flatten125_load + 11'd1);
...
assign h_vec_coeffs_address0 = zext_ln300_2_fu_181_p1;

assign icmp_ln298_fu_137_p2 = ((ap_sig_allocacmp_i_load == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln303_fu_220_p2 = (($signed(t_11_fu_214_p2) > $signed(32'd95231)) ? 1'b1 : 1'b0);

assign icmp_ln325_fu_113_p2 = ((ap_sig_allocacmp_indvar_flatten125_load == 11'd1024) ? 1'b1 : 1'b0);

assign select_ln300_fu_194_p3 = ((t_fu_186_p3[0:0] == 1'b1) ? 32'd4294967295 : 32'd0);

assign select_ln325_2_fu_151_p3 = ((icmp_ln298_fu_137_p2[0:0] == 1'b1) ? add_ln325_1_fu_131_p2 : ap_sig_allocacmp_i_14_load);

assign select_ln325_fu_143_p3 = ((icmp_ln298_fu_137_p2[0:0] == 1'b1) ? 9'd0 : ap_sig_allocacmp_i_load);

assign shl_ln301_fu_202_p2 = h_vec_coeffs_q0 << 32'd1;

assign t_11_fu_214_p2 = (h_vec_coeffs_q0 - and_ln301_fu_208_p2);

assign t_fu_186_p3 = h_vec_coeffs_q0[32'd31];

assign tmp_s_fu_163_p3 = {{trunc_ln300_fu_159_p1}, {8'd0}};

assign trunc_ln300_fu_159_p1 = select_ln325_2_fu_151_p3[1:0];

assign zext_ln300_2_fu_181_p1 = add_ln300_fu_175_p2;

assign zext_ln300_fu_171_p1 = select_ln325_fu_143_p3;

endmodule //crypto_sign_pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_325_1_VITIS_LOOP_298_1_1
