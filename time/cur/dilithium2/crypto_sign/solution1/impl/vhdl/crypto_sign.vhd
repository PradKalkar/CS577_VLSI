...
architecture behav of crypto_sign is 
    ...
    "crypto_sign_crypto_sign,hls_ip_2022_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200t-fbg676-2,HLS_INPUT_CLOCK=10000.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=31.143667,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=70,HLS_SYN_DSP=0,HLS_SYN_FF=31801,HLS_SYN_LUT=273519,HLS_VERSION=2022_2}";
    ...
    signal grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_start : STD_LOGIC;
    signal grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_done : STD_LOGIC;
    signal grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_idle : STD_LOGIC;
    signal grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_ready : STD_LOGIC;
    signal grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_m_address0 : STD_LOGIC_VECTOR (11 downto 0);
    signal grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_m_ce0 : STD_LOGIC;
    signal grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_sm_address0 : STD_LOGIC_VECTOR (12 downto 0);
    signal grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_sm_ce0 : STD_LOGIC;
    signal grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_sm_we0 : STD_LOGIC;
    signal grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_sm_d0 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_start_reg : STD_LOGIC := '0';
    ...
    signal empty_120_fu_88_p1 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    component crypto_sign_crypto_sign_Pipeline_VITIS_LOOP_205_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component crypto_sign_pqcrystals_dilithium2_ref_signature_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59 : component crypto_sign_crypto_sign_Pipeline_VITIS_LOOP_205_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_start,
        ap_done => grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_done,
        ap_idle => grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_idle,
        ap_ready => grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_ready,
        mlen => mlen,
        sub => sub_reg_119,
        m_address0 => grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_m_address0,
        m_ce0 => grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_m_ce0,
        m_q0 => m_q0,
        sub2 => sub2_reg_124,
        sm_address0 => grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_sm_address0,
        sm_ce0 => grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_sm_ce0,
        sm_we0 => grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_sm_we0,
        sm_d0 => grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_sm_d0);

    grp_pqcrystals_dilithium2_ref_signature_1_fu_71 : component crypto_sign_pqcrystals_dilithium2_ref_signature_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_ready = ap_const_logic_1)) then 
                    grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_done, grp_pqcrystals_dilithium2_ref_signature_1_fu_71_ap_done, ap_CS_fsm_state2, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    ap_ST_fsm_state2_blk_assign_proc : process(grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_done)
    begin
        if ((grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_done = ap_const_logic_0)) then 
    ...
    empty_120_fu_88_p1 <= mlen(12 - 1 downto 0);
    empty_fu_84_p1 <= mlen(13 - 1 downto 0);
    grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_start <= grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_ap_start_reg;
    ...
    sm_address0_assign_proc : process(grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_sm_address0, grp_pqcrystals_dilithium2_ref_signature_1_fu_71_sm_address0, ap_CS_fsm_state2, ap_CS_fsm_state4)
    begin
    ...
    sm_ce0_assign_proc : process(grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_sm_ce0, grp_pqcrystals_dilithium2_ref_signature_1_fu_71_sm_ce0, ap_CS_fsm_state2, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            sm_ce0 <= grp_pqcrystals_dilithium2_ref_signature_1_fu_71_sm_ce0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    sm_d0_assign_proc : process(grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_sm_d0, grp_pqcrystals_dilithium2_ref_signature_1_fu_71_sm_d0, ap_CS_fsm_state2, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            sm_d0 <= grp_pqcrystals_dilithium2_ref_signature_1_fu_71_sm_d0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    sm_we0_assign_proc : process(grp_crypto_sign_Pipeline_VITIS_LOOP_205_1_fu_59_sm_we0, grp_pqcrystals_dilithium2_ref_signature_1_fu_71_sm_we0, ap_CS_fsm_state2, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            sm_we0 <= grp_pqcrystals_dilithium2_ref_signature_1_fu_71_sm_we0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    sub_fu_92_p2 <= std_logic_vector(unsigned(empty_120_fu_88_p1) + unsigned(ap_const_lv12_FFF));
end behav;
