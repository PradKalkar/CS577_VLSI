...
architecture behav of polyveck_chknorm is 
    ...
    signal icmp_ln327_fu_107_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln327_reg_201 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and ((icmp_ln303_fu_191_p2 = ap_const_lv1_0) or (icmp_ln327_reg_201 = ap_const_lv1_1)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln303_fu_191_p2 = ap_const_lv1_1) and (icmp_ln327_reg_201 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                i_0_i_reg_80 <= i_20_reg_218;
            elsif (((icmp_ln327_fu_107_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln327_fu_107_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                p_0_reg_91 <= ap_const_lv1_0;
            elsif (((icmp_ln303_fu_191_p2 = ap_const_lv1_0) and (icmp_ln327_reg_201 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln327_fu_107_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, icmp_ln327_fu_107_p2, icmp_ln327_reg_201, ap_CS_fsm_state2, ap_CS_fsm_state3, icmp_ln298_fu_131_p2, ap_CS_fsm_state4, icmp_ln303_fu_191_p2)
    begin
        case ap_CS_fsm is
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, icmp_ln327_reg_201, ap_CS_fsm_state4, icmp_ln303_fu_191_p2)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state4) and ((icmp_ln303_fu_191_p2 = ap_const_lv1_0) or (icmp_ln327_reg_201 = ap_const_lv1_1))) or ((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    ap_phi_mux_p_0_phi_fu_95_p4_assign_proc : process(icmp_ln327_reg_201, ap_CS_fsm_state4, icmp_ln303_fu_191_p2, p_0_reg_91)
    begin
        if (((icmp_ln303_fu_191_p2 = ap_const_lv1_0) and (icmp_ln327_reg_201 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_ready_assign_proc : process(icmp_ln327_reg_201, ap_CS_fsm_state4, icmp_ln303_fu_191_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and ((icmp_ln303_fu_191_p2 = ap_const_lv1_0) or (icmp_ln327_reg_201 = ap_const_lv1_1)))) then 
    ...
    ap_return_assign_proc : process(icmp_ln327_reg_201, ap_CS_fsm_state4, icmp_ln303_fu_191_p2, ap_phi_mux_p_0_phi_fu_95_p4, ap_return_preg)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and ((icmp_ln303_fu_191_p2 = ap_const_lv1_0) or (icmp_ln327_reg_201 = ap_const_lv1_1)))) then 
    ...
    icmp_ln327_fu_107_p2 <= "1" when (i_0_reg_69 = ap_const_lv3_4) else "0";
