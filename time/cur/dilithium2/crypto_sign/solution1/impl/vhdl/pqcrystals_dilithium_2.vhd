...
entity pqcrystals_dilithium_2 is
port (
...
architecture behav of pqcrystals_dilithium_2 is 
    ...
    component crypto_sign_mac_mhbi IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    crypto_sign_mac_mhbi_U78 : component crypto_sign_mac_mhbi
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 9,
