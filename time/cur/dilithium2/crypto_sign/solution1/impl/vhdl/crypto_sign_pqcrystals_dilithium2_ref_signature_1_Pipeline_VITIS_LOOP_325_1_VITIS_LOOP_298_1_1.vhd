...
entity crypto_sign_pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_325_1_VITIS_LOOP_298_1_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of crypto_sign_pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_325_1_VITIS_LOOP_298_1_1 is 
    ...
    constant ap_const_lv32_173FF : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000010111001111111111";
...
attribute shreg_extract : string;
    ...
    signal add_ln325_fu_119_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal add_ln325_reg_269 : STD_LOGIC_VECTOR (10 downto 0);
    signal select_ln325_fu_143_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal select_ln325_reg_274 : STD_LOGIC_VECTOR (8 downto 0);
    signal select_ln325_2_fu_151_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln325_2_reg_279 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_phi_mux_merge_phi_fu_87_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln300_2_fu_181_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal i_14_fu_62 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_sig_allocacmp_i_14_load : STD_LOGIC_VECTOR (2 downto 0);
    signal indvar_flatten125_fu_66 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal add_ln325_1_fu_131_p2 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal t_11_fu_214_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
                ...
                i_14_fu_62 <= select_ln325_2_reg_279;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
                indvar_flatten125_fu_66 <= ap_const_lv11_0;
            elsif (((icmp_ln325_reg_265 = ap_const_lv1_0) and (icmp_ln303_fu_220_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                indvar_flatten125_fu_66 <= add_ln325_reg_269;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                add_ln325_reg_269 <= add_ln325_fu_119_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln325_fu_113_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                select_ln325_2_reg_279 <= select_ln325_2_fu_151_p3;
    ...
    add_ln325_1_fu_131_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_14_load) + unsigned(ap_const_lv3_1));
    add_ln325_fu_119_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten125_load) + unsigned(ap_const_lv11_1));
    ...
    ap_sig_allocacmp_i_14_load_assign_proc : process(ap_CS_fsm_state1, ap_loop_init, i_14_fu_62)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_sig_allocacmp_i_14_load <= ap_const_lv3_0;
        else 
            ap_sig_allocacmp_i_14_load <= i_14_fu_62;
        end if; 
    end process;
    ...
    ap_sig_allocacmp_indvar_flatten125_load_assign_proc : process(ap_CS_fsm_state1, ap_loop_init, indvar_flatten125_fu_66)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    h_vec_coeffs_address0 <= zext_ln300_2_fu_181_p1(10 - 1 downto 0);

    h_vec_coeffs_ce0_assign_proc : process(ap_CS_fsm_state1, ap_start_int)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
    ...
    icmp_ln303_fu_220_p2 <= "1" when (signed(t_11_fu_214_p2) > signed(ap_const_lv32_173FF)) else "0";
    icmp_ln325_fu_113_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten125_load = ap_const_lv11_400) else "0";
    select_ln300_fu_194_p3 <= 
        ap_const_lv32_FFFFFFFF when (t_fu_186_p3(0) = '1') else 
        ap_const_lv32_0;
    select_ln325_2_fu_151_p3 <= 
        add_ln325_1_fu_131_p2 when (icmp_ln298_fu_137_p2(0) = '1') else 
        ap_sig_allocacmp_i_14_load;
    select_ln325_fu_143_p3 <= 
        ap_const_lv9_0 when (icmp_ln298_fu_137_p2(0) = '1') else 
        ap_sig_allocacmp_i_load;
    shl_ln301_fu_202_p2 <= std_logic_vector(shift_left(unsigned(h_vec_coeffs_q0),to_integer(unsigned('0' & ap_const_lv32_1(31-1 downto 0)))));
    t_11_fu_214_p2 <= std_logic_vector(unsigned(h_vec_coeffs_q0) - unsigned(and_ln301_fu_208_p2));
    t_fu_186_p3 <= h_vec_coeffs_q0(31 downto 31);
    tmp_s_fu_163_p3 <= (trunc_ln300_fu_159_p1 & ap_const_lv8_0);
    trunc_ln300_fu_159_p1 <= select_ln325_2_fu_151_p3(2 - 1 downto 0);
    zext_ln300_2_fu_181_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln300_fu_175_p2),64));
