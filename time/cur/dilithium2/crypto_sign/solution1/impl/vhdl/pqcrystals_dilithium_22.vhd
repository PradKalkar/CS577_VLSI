...
entity pqcrystals_dilithium_22 is
port (
...
architecture behav of pqcrystals_dilithium_22 is 
    ...
    signal sext_ln19_1_fu_40_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    add_ln19_fu_44_p2 <= std_logic_vector(unsigned(a) + unsigned(sext_ln19_1_fu_40_p1));
    ...
    mul_ln19_fu_34_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(ap_const_lv55_7FFFFFFF801FFF) * signed(mul_ln19_fu_34_p1))), 55));
        sext_ln19_1_fu_40_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(mul_ln19_fu_34_p2),64));
