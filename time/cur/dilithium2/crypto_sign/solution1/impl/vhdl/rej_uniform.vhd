...
begin
    ...
    icmp_ln350_fu_223_p2 <= "1" when (unsigned(tmp_6_fu_213_p4) < unsigned(ap_const_lv23_7FE001)) else "0";
    ...
    tmp_6_fu_213_p4 <= ((trunc_ln348_fu_209_p1 & buf_r_q0) & buf_load_reg_310);
    ...
    zext_ln351_1_cast_fu_150_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_140_p4),13));
