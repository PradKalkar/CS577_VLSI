...
entity crypto_sign_keccak_absorb_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of crypto_sign_keccak_absorb_1 is 
...
attribute shreg_extract : string;
    ...
    signal empty_111_fu_376_p2 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal empty_112_fu_423_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln391_fu_437_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal empty_113_fu_452_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_114_fu_456_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_391_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_30_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_400_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component crypto_sign_KeccakF1600_StatePermute IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_409_4 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_416_5 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_423_6 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_425_7 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_30_124 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component crypto_sign_keccak_absorb_1_t_RAM_AUTO_1R1W IS
    generic (
        DataWidth : INTEGER;
...
begin
    t_U : component crypto_sign_keccak_absorb_1_t_RAM_AUTO_1R1W
    generic map (
        DataWidth => 8,
        AddressRange => 8,
        AddressWidth => 3)
    ...
    grp_keccak_absorb_1_Pipeline_VITIS_LOOP_391_1_fu_262 : component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_391_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_keccak_absorb_1_Pipeline_VITIS_LOOP_30_1_fu_272 : component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_30_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_keccak_absorb_1_Pipeline_VITIS_LOOP_400_2_fu_278 : component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_400_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_KeccakF1600_StatePermute_fu_291 : component crypto_sign_KeccakF1600_StatePermute
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_keccak_absorb_1_Pipeline_VITIS_LOOP_409_4_fu_299 : component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_409_4
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_keccak_absorb_1_Pipeline_VITIS_LOOP_416_5_fu_309 : component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_416_5
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_keccak_absorb_1_Pipeline_VITIS_LOOP_423_6_fu_320 : component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_423_6
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_keccak_absorb_1_Pipeline_VITIS_LOOP_425_7_fu_325 : component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_425_7
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_keccak_absorb_1_Pipeline_VITIS_LOOP_30_124_fu_335 : component crypto_sign_keccak_absorb_1_Pipeline_VITIS_LOOP_30_124
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                ...
                empty_fu_104 <= empty_111_fu_376_p2;
            end if; 
        end if;
    end process;
    ...
    add_ln382_fu_471_p2 <= std_logic_vector(unsigned(pos_offset_cast6_cast_cast_cast_reg_785) + unsigned(empty_114_fu_456_p2));
    ...
    empty_111_fu_376_p2 <= std_logic_vector(unsigned(empty_fu_104) + unsigned(ap_const_lv4_1));
    empty_112_fu_423_p2 <= "1" when (unsigned(xor_ln391_1_cast_fu_419_p1) < unsigned(xor_ln391_fu_392_p2)) else "0";
    empty_113_fu_452_p1 <= umax_fu_429_p3(8 - 1 downto 0);
    empty_114_fu_456_p2 <= (trunc_ln391_fu_437_p1 xor ap_const_lv32_FFFFFFFF);
    ...
    umax_fu_429_p3 <= 
        xor_ln391_fu_392_p2 when (empty_112_fu_423_p2(0) = '1') else 
        xor_ln391_1_cast_fu_419_p1;
    xor_ln384_fu_462_p2 <= (empty_113_fu_452_p1 xor ap_const_lv8_FF);
