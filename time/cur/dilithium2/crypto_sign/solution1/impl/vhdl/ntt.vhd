...
architecture behav of ntt is 
    ...
    signal tmp_100_fu_162_p4 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp_101_fu_192_p4 : STD_LOGIC_VECTOR (27 downto 0);
    signal add_ln57_fu_206_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal empty_59_fu_215_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    empty_59_fu_215_p2 <= "1" when (unsigned(j_reg_110) > unsigned(add_ln57_fu_206_p2)) else "0";
    icmp_ln54_fu_152_p2 <= "1" when (len_0_reg_98 = ap_const_lv29_0) else "0";
    icmp_ln55_fu_172_p2 <= "1" when (tmp_100_fu_162_p4 = ap_const_lv23_0) else "0";
    ...
    start_fu_229_p3 <= 
        trunc_ln55_fu_221_p1 when (empty_59_fu_215_p2(0) = '1') else 
    ...
    tmp_100_fu_162_p4 <= j_reg_110(30 downto 8);
    tmp_101_fu_192_p4 <= len_0_reg_98(28 downto 1);
    ...
    zext_ln54_3_fu_202_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_101_fu_192_p4),29));
