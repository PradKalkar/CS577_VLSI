...
using hls::sim::Byte;
extern "C" int crypto_sign(Byte<1>*, volatile void *, Byte<1>*, long long, Byte<1>*);
extern "C" int apatb_crypto_sign_hw(volatile void * __xlx_apatb_param_sm, volatile void * __xlx_apatb_param_smlen, volatile void * __xlx_apatb_param_m, long long __xlx_apatb_param_mlen, volatile void * __xlx_apatb_param_sk) {
...
__xlx_sk__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_sk)[i]);
  ...
  // DUT call
  int ap_return = crypto_sign(__xlx_sm__tmp_vec.data(), __xlx_apatb_param_smlen, __xlx_m__tmp_vec.data(), __xlx_apatb_param_mlen, __xlx_sk__tmp_vec.data());
